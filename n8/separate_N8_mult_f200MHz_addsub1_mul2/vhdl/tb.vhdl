...
begin
    ...
    begin
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.6552298665046692)) <= 0.0 + 1.0e-05 * abs(0.6552298665046692)
            report "Error detected at cycle 224: out0_0_out expected 0.6552298665046692, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 225
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.024337125942111015)) <= 0.0 + 1.0e-05 * abs(-0.024337125942111015)
            report "Error detected at cycle 225: out0_0_out expected -0.024337125942111015, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 226
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.6230738162994385)) <= 0.0 + 1.0e-05 * abs(0.6230738162994385)
            report "Error detected at cycle 226: out0_0_out expected 0.6230738162994385, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 227
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.07118867337703705)) <= 0.0 + 1.0e-05 * abs(-0.07118867337703705)
            report "Error detected at cycle 227: out0_0_out expected -0.07118867337703705, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 228
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.19113214313983917)) <= 0.0 + 1.0e-05 * abs(-0.19113214313983917)
            report "Error detected at cycle 228: out0_0_out expected -0.19113214313983917, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 229
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.28758031129837036)) <= 0.0 + 1.0e-05 * abs(0.28758031129837036)
            report "Error detected at cycle 229: out0_0_out expected 0.28758031129837036, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 230
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.23138302564620972)) <= 0.0 + 1.0e-05 * abs(-0.23138302564620972)
            report "Error detected at cycle 230: out0_0_out expected -0.23138302564620972, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 231
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (1.0227673053741455)) <= 0.0 + 1.0e-05 * abs(1.0227673053741455)
            report "Error detected at cycle 231: out0_0_out expected 1.0227673053741455, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 232
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.5404293537139893)) <= 0.0 + 1.0e-05 * abs(0.5404293537139893)
            report "Error detected at cycle 232: out0_0_out expected 0.5404293537139893, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 233
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.12129056453704834)) <= 0.0 + 1.0e-05 * abs(-0.12129056453704834)
            report "Error detected at cycle 233: out0_0_out expected -0.12129056453704834, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 234
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (1.0031542778015137)) <= 0.0 + 1.0e-05 * abs(1.0031542778015137)
            report "Error detected at cycle 234: out0_0_out expected 1.0031542778015137, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 235
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.008897637948393822)) <= 0.0 + 1.0e-05 * abs(0.008897637948393822)
            report "Error detected at cycle 235: out0_0_out expected 0.008897637948393822, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 236
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.2282794713973999)) <= 0.0 + 1.0e-05 * abs(-0.2282794713973999)
            report "Error detected at cycle 236: out0_0_out expected -0.2282794713973999, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 237
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.5107254385948181)) <= 0.0 + 1.0e-05 * abs(-0.5107254385948181)
            report "Error detected at cycle 237: out0_0_out expected -0.5107254385948181, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 238
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.595527172088623)) <= 0.0 + 1.0e-05 * abs(0.595527172088623)
            report "Error detected at cycle 238: out0_0_out expected 0.595527172088623, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 239
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.14631810784339905)) <= 0.0 + 1.0e-05 * abs(0.14631810784339905)
            report "Error detected at cycle 239: out0_0_out expected 0.14631810784339905, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 240
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.10431204736232758)) <= 0.0 + 1.0e-05 * abs(-0.10431204736232758)
            report "Error detected at cycle 240: out0_0_out expected -0.10431204736232758, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 241
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.05513254180550575)) <= 0.0 + 1.0e-05 * abs(-0.05513254180550575)
            report "Error detected at cycle 241: out0_0_out expected -0.05513254180550575, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 242
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.013774358667433262)) <= 0.0 + 1.0e-05 * abs(-0.013774358667433262)
            report "Error detected at cycle 242: out0_0_out expected -0.013774358667433262, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 243
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.10824299603700638)) <= 0.0 + 1.0e-05 * abs(-0.10824299603700638)
            report "Error detected at cycle 243: out0_0_out expected -0.10824299603700638, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 244
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.02348753809928894)) <= 0.0 + 1.0e-05 * abs(-0.02348753809928894)
            report "Error detected at cycle 244: out0_0_out expected -0.02348753809928894, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 245
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.1428597867488861)) <= 0.0 + 1.0e-05 * abs(0.1428597867488861)
            report "Error detected at cycle 245: out0_0_out expected 0.1428597867488861, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 246
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.4185147285461426)) <= 0.0 + 1.0e-05 * abs(-0.4185147285461426)
            report "Error detected at cycle 246: out0_0_out expected -0.4185147285461426, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 247
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.14721275866031647)) <= 0.0 + 1.0e-05 * abs(-0.14721275866031647)
            report "Error detected at cycle 247: out0_0_out expected -0.14721275866031647, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 248
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.0010980579536408186)) <= 0.0 + 1.0e-05 * abs(0.0010980579536408186)
            report "Error detected at cycle 248: out0_0_out expected 0.0010980579536408186, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 249
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.07288522273302078)) <= 0.0 + 1.0e-05 * abs(0.07288522273302078)
            report "Error detected at cycle 249: out0_0_out expected 0.07288522273302078, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 250
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.20239722728729248)) <= 0.0 + 1.0e-05 * abs(-0.20239722728729248)
            report "Error detected at cycle 250: out0_0_out expected -0.20239722728729248, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 251
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.038591064512729645)) <= 0.0 + 1.0e-05 * abs(-0.038591064512729645)
            report "Error detected at cycle 251: out0_0_out expected -0.038591064512729645, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 252
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.1676914542913437)) <= 0.0 + 1.0e-05 * abs(-0.1676914542913437)
            report "Error detected at cycle 252: out0_0_out expected -0.1676914542913437, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 253
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.05378502979874611)) <= 0.0 + 1.0e-05 * abs(0.05378502979874611)
            report "Error detected at cycle 253: out0_0_out expected 0.05378502979874611, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 254
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.11348739266395569)) <= 0.0 + 1.0e-05 * abs(-0.11348739266395569)
            report "Error detected at cycle 254: out0_0_out expected -0.11348739266395569, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 255
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.08005347847938538)) <= 0.0 + 1.0e-05 * abs(-0.08005347847938538)
            report "Error detected at cycle 255: out0_0_out expected -0.08005347847938538, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 256
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (1.11365807056427)) <= 0.0 + 1.0e-05 * abs(1.11365807056427)
            report "Error detected at cycle 256: out0_0_out expected 1.11365807056427, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 257
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.04889813810586929)) <= 0.0 + 1.0e-05 * abs(-0.04889813810586929)
            report "Error detected at cycle 257: out0_0_out expected -0.04889813810586929, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 258
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.13396699726581573)) <= 0.0 + 1.0e-05 * abs(-0.13396699726581573)
            report "Error detected at cycle 258: out0_0_out expected -0.13396699726581573, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
