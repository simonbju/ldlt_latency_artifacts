...
begin
    ...
    begin
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.6399386525154114)) <= 0.0 + 1.0e-05 * abs(0.6399386525154114)
            report "Error detected at cycle 350: out0_0_out expected 0.6399386525154114, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.6552298665046692)) <= 0.0 + 1.0e-05 * abs(0.6552298665046692)
            report "Error detected at cycle 404: out0_0_out expected 0.6552298665046692, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 405
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.13396699726581573)) <= 0.0 + 1.0e-05 * abs(-0.13396699726581573)
            report "Error detected at cycle 405: out0_0_out expected -0.13396699726581573, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 406
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.04889813810586929)) <= 0.0 + 1.0e-05 * abs(-0.04889813810586929)
            report "Error detected at cycle 406: out0_0_out expected -0.04889813810586929, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 407
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.0010980579536408186)) <= 0.0 + 1.0e-05 * abs(0.0010980579536408186)
            report "Error detected at cycle 407: out0_0_out expected 0.0010980579536408186, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 408
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.07118867337703705)) <= 0.0 + 1.0e-05 * abs(-0.07118867337703705)
            report "Error detected at cycle 408: out0_0_out expected -0.07118867337703705, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 409
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.038591064512729645)) <= 0.0 + 1.0e-05 * abs(-0.038591064512729645)
            report "Error detected at cycle 409: out0_0_out expected -0.038591064512729645, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 410
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.024337125942111015)) <= 0.0 + 1.0e-05 * abs(-0.024337125942111015)
            report "Error detected at cycle 410: out0_0_out expected -0.024337125942111015, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 411
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.1428597867488861)) <= 0.0 + 1.0e-05 * abs(0.1428597867488861)
            report "Error detected at cycle 411: out0_0_out expected 0.1428597867488861, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 412
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.1676914542913437)) <= 0.0 + 1.0e-05 * abs(-0.1676914542913437)
            report "Error detected at cycle 412: out0_0_out expected -0.1676914542913437, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 413
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.02348753809928894)) <= 0.0 + 1.0e-05 * abs(-0.02348753809928894)
            report "Error detected at cycle 413: out0_0_out expected -0.02348753809928894, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 414
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.10824299603700638)) <= 0.0 + 1.0e-05 * abs(-0.10824299603700638)
            report "Error detected at cycle 414: out0_0_out expected -0.10824299603700638, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 415
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.008897637948393822)) <= 0.0 + 1.0e-05 * abs(0.008897637948393822)
            report "Error detected at cycle 415: out0_0_out expected 0.008897637948393822, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 416
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.14721275866031647)) <= 0.0 + 1.0e-05 * abs(-0.14721275866031647)
            report "Error detected at cycle 416: out0_0_out expected -0.14721275866031647, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 417
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.08005347847938538)) <= 0.0 + 1.0e-05 * abs(-0.08005347847938538)
            report "Error detected at cycle 417: out0_0_out expected -0.08005347847938538, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 418
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.6230738162994385)) <= 0.0 + 1.0e-05 * abs(0.6230738162994385)
            report "Error detected at cycle 418: out0_0_out expected 0.6230738162994385, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 419
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (1.11365807056427)) <= 0.0 + 1.0e-05 * abs(1.11365807056427)
            report "Error detected at cycle 419: out0_0_out expected 1.11365807056427, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 420
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (1.0227673053741455)) <= 0.0 + 1.0e-05 * abs(1.0227673053741455)
            report "Error detected at cycle 420: out0_0_out expected 1.0227673053741455, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 421
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.4185147285461426)) <= 0.0 + 1.0e-05 * abs(-0.4185147285461426)
            report "Error detected at cycle 421: out0_0_out expected -0.4185147285461426, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 422
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.10431204736232758)) <= 0.0 + 1.0e-05 * abs(-0.10431204736232758)
            report "Error detected at cycle 422: out0_0_out expected -0.10431204736232758, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 423
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.28758031129837036)) <= 0.0 + 1.0e-05 * abs(0.28758031129837036)
            report "Error detected at cycle 423: out0_0_out expected 0.28758031129837036, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 424
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.23138302564620972)) <= 0.0 + 1.0e-05 * abs(-0.23138302564620972)
            report "Error detected at cycle 424: out0_0_out expected -0.23138302564620972, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 425
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.5404293537139893)) <= 0.0 + 1.0e-05 * abs(0.5404293537139893)
            report "Error detected at cycle 425: out0_0_out expected 0.5404293537139893, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 426
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.013774358667433262)) <= 0.0 + 1.0e-05 * abs(-0.013774358667433262)
            report "Error detected at cycle 426: out0_0_out expected -0.013774358667433262, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 427
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.05513254180550575)) <= 0.0 + 1.0e-05 * abs(-0.05513254180550575)
            report "Error detected at cycle 427: out0_0_out expected -0.05513254180550575, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 428
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.12129056453704834)) <= 0.0 + 1.0e-05 * abs(-0.12129056453704834)
            report "Error detected at cycle 428: out0_0_out expected -0.12129056453704834, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 429
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (1.0031542778015137)) <= 0.0 + 1.0e-05 * abs(1.0031542778015137)
            report "Error detected at cycle 429: out0_0_out expected 1.0031542778015137, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 430
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.5107254385948181)) <= 0.0 + 1.0e-05 * abs(-0.5107254385948181)
            report "Error detected at cycle 430: out0_0_out expected -0.5107254385948181, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 431
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.2282794713973999)) <= 0.0 + 1.0e-05 * abs(-0.2282794713973999)
            report "Error detected at cycle 431: out0_0_out expected -0.2282794713973999, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 432
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.595527172088623)) <= 0.0 + 1.0e-05 * abs(0.595527172088623)
            report "Error detected at cycle 432: out0_0_out expected 0.595527172088623, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 433
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.14631810784339905)) <= 0.0 + 1.0e-05 * abs(0.14631810784339905)
            report "Error detected at cycle 433: out0_0_out expected 0.14631810784339905, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 434
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.19113214313983917)) <= 0.0 + 1.0e-05 * abs(-0.19113214313983917)
            report "Error detected at cycle 434: out0_0_out expected -0.19113214313983917, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 435
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.07288522273302078)) <= 0.0 + 1.0e-05 * abs(0.07288522273302078)
            report "Error detected at cycle 435: out0_0_out expected 0.07288522273302078, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 436
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.20239722728729248)) <= 0.0 + 1.0e-05 * abs(-0.20239722728729248)
            report "Error detected at cycle 436: out0_0_out expected -0.20239722728729248, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 437
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.05378502979874611)) <= 0.0 + 1.0e-05 * abs(0.05378502979874611)
            report "Error detected at cycle 437: out0_0_out expected 0.05378502979874611, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 438
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.11348739266395569)) <= 0.0 + 1.0e-05 * abs(-0.11348739266395569)
            report "Error detected at cycle 438: out0_0_out expected -0.11348739266395569, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
