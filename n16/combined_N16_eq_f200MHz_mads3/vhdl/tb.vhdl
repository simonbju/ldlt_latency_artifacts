...
begin
    ...
    begin
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.667209804058075)) <= 0.0 + 1.0e-05 * abs(0.667209804058075)
            report "Error detected at cycle 450: out0_0_out expected 0.667209804058075, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.13006529211997986)) <= 0.0 + 1.0e-05 * abs(-0.13006529211997986)
            report "Error detected at cycle 458: out0_0_out expected -0.13006529211997986, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.6996414065361023)) <= 0.0 + 1.0e-05 * abs(0.6996414065361023)
            report "Error detected at cycle 466: out0_0_out expected 0.6996414065361023, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 467
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.044508196413517)) <= 0.0 + 1.0e-05 * abs(0.044508196413517)
            report "Error detected at cycle 467: out0_0_out expected 0.044508196413517, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.09199580550193787)) <= 0.0 + 1.0e-05 * abs(-0.09199580550193787)
            report "Error detected at cycle 474: out0_0_out expected -0.09199580550193787, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 475
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.05222167447209358)) <= 0.0 + 1.0e-05 * abs(0.05222167447209358)
            report "Error detected at cycle 475: out0_0_out expected 0.05222167447209358, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.07310182601213455)) <= 0.0 + 1.0e-05 * abs(-0.07310182601213455)
            report "Error detected at cycle 482: out0_0_out expected -0.07310182601213455, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 483
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.8149998784065247)) <= 0.0 + 1.0e-05 * abs(0.8149998784065247)
            report "Error detected at cycle 483: out0_0_out expected 0.8149998784065247, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 484
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.03961186483502388)) <= 0.0 + 1.0e-05 * abs(0.03961186483502388)
            report "Error detected at cycle 484: out0_0_out expected 0.03961186483502388, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.04822874069213867)) <= 0.0 + 1.0e-05 * abs(0.04822874069213867)
            report "Error detected at cycle 490: out0_0_out expected 0.04822874069213867, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 491
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.23289696872234344)) <= 0.0 + 1.0e-05 * abs(-0.23289696872234344)
            report "Error detected at cycle 491: out0_0_out expected -0.23289696872234344, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 492
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.05277242884039879)) <= 0.0 + 1.0e-05 * abs(-0.05277242884039879)
            report "Error detected at cycle 492: out0_0_out expected -0.05277242884039879, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.599850058555603)) <= 0.0 + 1.0e-05 * abs(0.599850058555603)
            report "Error detected at cycle 498: out0_0_out expected 0.599850058555603, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 499
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.027070321142673492)) <= 0.0 + 1.0e-05 * abs(-0.027070321142673492)
            report "Error detected at cycle 499: out0_0_out expected -0.027070321142673492, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 500
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.034411098808050156)) <= 0.0 + 1.0e-05 * abs(0.034411098808050156)
            report "Error detected at cycle 500: out0_0_out expected 0.034411098808050156, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 501
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.0406595841050148)) <= 0.0 + 1.0e-05 * abs(0.0406595841050148)
            report "Error detected at cycle 501: out0_0_out expected 0.0406595841050148, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.009396038949489594)) <= 0.0 + 1.0e-05 * abs(-0.009396038949489594)
            report "Error detected at cycle 506: out0_0_out expected -0.009396038949489594, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 507
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.02187284082174301)) <= 0.0 + 1.0e-05 * abs(-0.02187284082174301)
            report "Error detected at cycle 507: out0_0_out expected -0.02187284082174301, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 508
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.13416258990764618)) <= 0.0 + 1.0e-05 * abs(-0.13416258990764618)
            report "Error detected at cycle 508: out0_0_out expected -0.13416258990764618, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.10696083307266235)) <= 0.0 + 1.0e-05 * abs(0.10696083307266235)
            report "Error detected at cycle 511: out0_0_out expected 0.10696083307266235, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.027921007946133614)) <= 0.0 + 1.0e-05 * abs(-0.027921007946133614)
            report "Error detected at cycle 514: out0_0_out expected -0.027921007946133614, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 515
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.06243869289755821)) <= 0.0 + 1.0e-05 * abs(0.06243869289755821)
            report "Error detected at cycle 515: out0_0_out expected 0.06243869289755821, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 516
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.4887613356113434)) <= 0.0 + 1.0e-05 * abs(0.4887613356113434)
            report "Error detected at cycle 516: out0_0_out expected 0.4887613356113434, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.029970936477184296)) <= 0.0 + 1.0e-05 * abs(-0.029970936477184296)
            report "Error detected at cycle 522: out0_0_out expected -0.029970936477184296, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 523
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.07640542834997177)) <= 0.0 + 1.0e-05 * abs(-0.07640542834997177)
            report "Error detected at cycle 523: out0_0_out expected -0.07640542834997177, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 524
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.1351722627878189)) <= 0.0 + 1.0e-05 * abs(-0.1351722627878189)
            report "Error detected at cycle 524: out0_0_out expected -0.1351722627878189, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.7447478175163269)) <= 0.0 + 1.0e-05 * abs(0.7447478175163269)
            report "Error detected at cycle 530: out0_0_out expected 0.7447478175163269, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.008170685730874538)) <= 0.0 + 1.0e-05 * abs(-0.008170685730874538)
            report "Error detected at cycle 533: out0_0_out expected -0.008170685730874538, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.13164180517196655)) <= 0.0 + 1.0e-05 * abs(-0.13164180517196655)
            report "Error detected at cycle 535: out0_0_out expected -0.13164180517196655, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.08169203251600266)) <= 0.0 + 1.0e-05 * abs(-0.08169203251600266)
            report "Error detected at cycle 538: out0_0_out expected -0.08169203251600266, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.047435302287340164)) <= 0.0 + 1.0e-05 * abs(0.047435302287340164)
            report "Error detected at cycle 546: out0_0_out expected 0.047435302287340164, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.012657813727855682)) <= 0.0 + 1.0e-05 * abs(0.012657813727855682)
            report "Error detected at cycle 548: out0_0_out expected 0.012657813727855682, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.03533279150724411)) <= 0.0 + 1.0e-05 * abs(-0.03533279150724411)
            report "Error detected at cycle 551: out0_0_out expected -0.03533279150724411, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.02206876315176487)) <= 0.0 + 1.0e-05 * abs(-0.02206876315176487)
            report "Error detected at cycle 563: out0_0_out expected -0.02206876315176487, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.038455765694379807)) <= 0.0 + 1.0e-05 * abs(0.038455765694379807)
            report "Error detected at cycle 565: out0_0_out expected 0.038455765694379807, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.10012456029653549)) <= 0.0 + 1.0e-05 * abs(0.10012456029653549)
            report "Error detected at cycle 569: out0_0_out expected 0.10012456029653549, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 570
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.5832412242889404)) <= 0.0 + 1.0e-05 * abs(0.5832412242889404)
            report "Error detected at cycle 570: out0_0_out expected 0.5832412242889404, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.17430882155895233)) <= 0.0 + 1.0e-05 * abs(-0.17430882155895233)
            report "Error detected at cycle 579: out0_0_out expected -0.17430882155895233, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.003185315988957882)) <= 0.0 + 1.0e-05 * abs(0.003185315988957882)
            report "Error detected at cycle 582: out0_0_out expected 0.003185315988957882, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.0931301936507225)) <= 0.0 + 1.0e-05 * abs(-0.0931301936507225)
            report "Error detected at cycle 585: out0_0_out expected -0.0931301936507225, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.007004107348620892)) <= 0.0 + 1.0e-05 * abs(0.007004107348620892)
            report "Error detected at cycle 597: out0_0_out expected 0.007004107348620892, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.07240854203701019)) <= 0.0 + 1.0e-05 * abs(-0.07240854203701019)
            report "Error detected at cycle 600: out0_0_out expected -0.07240854203701019, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.007942136377096176)) <= 0.0 + 1.0e-05 * abs(0.007942136377096176)
            report "Error detected at cycle 603: out0_0_out expected 0.007942136377096176, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.1705726683139801)) <= 0.0 + 1.0e-05 * abs(-0.1705726683139801)
            report "Error detected at cycle 607: out0_0_out expected -0.1705726683139801, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.2874801754951477)) <= 0.0 + 1.0e-05 * abs(-0.2874801754951477)
            report "Error detected at cycle 618: out0_0_out expected -0.2874801754951477, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.03942936286330223)) <= 0.0 + 1.0e-05 * abs(-0.03942936286330223)
            report "Error detected at cycle 622: out0_0_out expected -0.03942936286330223, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.07523210346698761)) <= 0.0 + 1.0e-05 * abs(-0.07523210346698761)
            report "Error detected at cycle 626: out0_0_out expected -0.07523210346698761, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 627
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.5250609517097473)) <= 0.0 + 1.0e-05 * abs(0.5250609517097473)
            report "Error detected at cycle 627: out0_0_out expected 0.5250609517097473, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.020268496125936508)) <= 0.0 + 1.0e-05 * abs(-0.020268496125936508)
            report "Error detected at cycle 638: out0_0_out expected -0.020268496125936508, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.013914039358496666)) <= 0.0 + 1.0e-05 * abs(0.013914039358496666)
            report "Error detected at cycle 641: out0_0_out expected 0.013914039358496666, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.2634851038455963)) <= 0.0 + 1.0e-05 * abs(-0.2634851038455963)
            report "Error detected at cycle 645: out0_0_out expected -0.2634851038455963, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.13064123690128326)) <= 0.0 + 1.0e-05 * abs(-0.13064123690128326)
            report "Error detected at cycle 650: out0_0_out expected -0.13064123690128326, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.04851575940847397)) <= 0.0 + 1.0e-05 * abs(0.04851575940847397)
            report "Error detected at cycle 658: out0_0_out expected 0.04851575940847397, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.09702011197805405)) <= 0.0 + 1.0e-05 * abs(0.09702011197805405)
            report "Error detected at cycle 661: out0_0_out expected 0.09702011197805405, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.1454460620880127)) <= 0.0 + 1.0e-05 * abs(0.1454460620880127)
            report "Error detected at cycle 665: out0_0_out expected 0.1454460620880127, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.18194514513015747)) <= 0.0 + 1.0e-05 * abs(-0.18194514513015747)
            report "Error detected at cycle 670: out0_0_out expected -0.18194514513015747, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.06804811209440231)) <= 0.0 + 1.0e-05 * abs(0.06804811209440231)
            report "Error detected at cycle 681: out0_0_out expected 0.06804811209440231, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.0827391967177391)) <= 0.0 + 1.0e-05 * abs(-0.0827391967177391)
            report "Error detected at cycle 686: out0_0_out expected -0.0827391967177391, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.20848862826824188)) <= 0.0 + 1.0e-05 * abs(-0.20848862826824188)
            report "Error detected at cycle 690: out0_0_out expected -0.20848862826824188, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 691
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.9502374529838562)) <= 0.0 + 1.0e-05 * abs(0.9502374529838562)
            report "Error detected at cycle 691: out0_0_out expected 0.9502374529838562, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.029979869723320007)) <= 0.0 + 1.0e-05 * abs(-0.029979869723320007)
            report "Error detected at cycle 694: out0_0_out expected -0.029979869723320007, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.03399326652288437)) <= 0.0 + 1.0e-05 * abs(0.03399326652288437)
            report "Error detected at cycle 702: out0_0_out expected 0.03399326652288437, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.06502603739500046)) <= 0.0 + 1.0e-05 * abs(-0.06502603739500046)
            report "Error detected at cycle 706: out0_0_out expected -0.06502603739500046, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.14445462822914124)) <= 0.0 + 1.0e-05 * abs(0.14445462822914124)
            report "Error detected at cycle 711: out0_0_out expected 0.14445462822914124, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.21584199368953705)) <= 0.0 + 1.0e-05 * abs(0.21584199368953705)
            report "Error detected at cycle 714: out0_0_out expected 0.21584199368953705, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.22975283861160278)) <= 0.0 + 1.0e-05 * abs(-0.22975283861160278)
            report "Error detected at cycle 722: out0_0_out expected -0.22975283861160278, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.13752800226211548)) <= 0.0 + 1.0e-05 * abs(-0.13752800226211548)
            report "Error detected at cycle 726: out0_0_out expected -0.13752800226211548, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.10669464617967606)) <= 0.0 + 1.0e-05 * abs(-0.10669464617967606)
            report "Error detected at cycle 731: out0_0_out expected -0.10669464617967606, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.13680604100227356)) <= 0.0 + 1.0e-05 * abs(0.13680604100227356)
            report "Error detected at cycle 734: out0_0_out expected 0.13680604100227356, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.10311596095561981)) <= 0.0 + 1.0e-05 * abs(-0.10311596095561981)
            report "Error detected at cycle 737: out0_0_out expected -0.10311596095561981, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.03924935311079025)) <= 0.0 + 1.0e-05 * abs(0.03924935311079025)
            report "Error detected at cycle 746: out0_0_out expected 0.03924935311079025, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.014474628493189812)) <= 0.0 + 1.0e-05 * abs(0.014474628493189812)
            report "Error detected at cycle 751: out0_0_out expected 0.014474628493189812, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.12730126082897186)) <= 0.0 + 1.0e-05 * abs(-0.12730126082897186)
            report "Error detected at cycle 753: out0_0_out expected -0.12730126082897186, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 754
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.5708498358726501)) <= 0.0 + 1.0e-05 * abs(0.5708498358726501)
            report "Error detected at cycle 754: out0_0_out expected 0.5708498358726501, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.03195594996213913)) <= 0.0 + 1.0e-05 * abs(0.03195594996213913)
            report "Error detected at cycle 757: out0_0_out expected 0.03195594996213913, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.015442159958183765)) <= 0.0 + 1.0e-05 * abs(0.015442159958183765)
            report "Error detected at cycle 766: out0_0_out expected 0.015442159958183765, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.06466279923915863)) <= 0.0 + 1.0e-05 * abs(-0.06466279923915863)
            report "Error detected at cycle 771: out0_0_out expected -0.06466279923915863, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.05580083280801773)) <= 0.0 + 1.0e-05 * abs(0.05580083280801773)
            report "Error detected at cycle 773: out0_0_out expected 0.05580083280801773, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.0063568465411663055)) <= 0.0 + 1.0e-05 * abs(0.0063568465411663055)
            report "Error detected at cycle 775: out0_0_out expected 0.0063568465411663055, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.16565842926502228)) <= 0.0 + 1.0e-05 * abs(-0.16565842926502228)
            report "Error detected at cycle 779: out0_0_out expected -0.16565842926502228, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.04903075098991394)) <= 0.0 + 1.0e-05 * abs(-0.04903075098991394)
            report "Error detected at cycle 784: out0_0_out expected -0.04903075098991394, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.03877269849181175)) <= 0.0 + 1.0e-05 * abs(-0.03877269849181175)
            report "Error detected at cycle 789: out0_0_out expected -0.03877269849181175, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.1013529971241951)) <= 0.0 + 1.0e-05 * abs(-0.1013529971241951)
            report "Error detected at cycle 791: out0_0_out expected -0.1013529971241951, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.1079598069190979)) <= 0.0 + 1.0e-05 * abs(-0.1079598069190979)
            report "Error detected at cycle 793: out0_0_out expected -0.1079598069190979, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.10581439733505249)) <= 0.0 + 1.0e-05 * abs(-0.10581439733505249)
            report "Error detected at cycle 797: out0_0_out expected -0.10581439733505249, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.23986510932445526)) <= 0.0 + 1.0e-05 * abs(-0.23986510932445526)
            report "Error detected at cycle 807: out0_0_out expected -0.23986510932445526, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 808
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.17547553777694702)) <= 0.0 + 1.0e-05 * abs(-0.17547553777694702)
            report "Error detected at cycle 808: out0_0_out expected -0.17547553777694702, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.6682536602020264)) <= 0.0 + 1.0e-05 * abs(0.6682536602020264)
            report "Error detected at cycle 810: out0_0_out expected 0.6682536602020264, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 811
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.04815756529569626)) <= 0.0 + 1.0e-05 * abs(-0.04815756529569626)
            report "Error detected at cycle 811: out0_0_out expected -0.04815756529569626, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.21714015305042267)) <= 0.0 + 1.0e-05 * abs(-0.21714015305042267)
            report "Error detected at cycle 814: out0_0_out expected -0.21714015305042267, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.13348814845085144)) <= 0.0 + 1.0e-05 * abs(0.13348814845085144)
            report "Error detected at cycle 818: out0_0_out expected 0.13348814845085144, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.014418991282582283)) <= 0.0 + 1.0e-05 * abs(-0.014418991282582283)
            report "Error detected at cycle 823: out0_0_out expected -0.014418991282582283, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 824
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.0699249729514122)) <= 0.0 + 1.0e-05 * abs(-0.0699249729514122)
            report "Error detected at cycle 824: out0_0_out expected -0.0699249729514122, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.0023358725011348724)) <= 0.0 + 1.0e-05 * abs(-0.0023358725011348724)
            report "Error detected at cycle 826: out0_0_out expected -0.0023358725011348724, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.1247539222240448)) <= 0.0 + 1.0e-05 * abs(0.1247539222240448)
            report "Error detected at cycle 829: out0_0_out expected 0.1247539222240448, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.05220543220639229)) <= 0.0 + 1.0e-05 * abs(-0.05220543220639229)
            report "Error detected at cycle 833: out0_0_out expected -0.05220543220639229, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.20743325352668762)) <= 0.0 + 1.0e-05 * abs(0.20743325352668762)
            report "Error detected at cycle 838: out0_0_out expected 0.20743325352668762, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 839
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.10327304899692535)) <= 0.0 + 1.0e-05 * abs(0.10327304899692535)
            report "Error detected at cycle 839: out0_0_out expected 0.10327304899692535, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 840
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.053609464317560196)) <= 0.0 + 1.0e-05 * abs(0.053609464317560196)
            report "Error detected at cycle 840: out0_0_out expected 0.053609464317560196, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.18026866018772125)) <= 0.0 + 1.0e-05 * abs(-0.18026866018772125)
            report "Error detected at cycle 843: out0_0_out expected -0.18026866018772125, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.13309159874916077)) <= 0.0 + 1.0e-05 * abs(0.13309159874916077)
            report "Error detected at cycle 847: out0_0_out expected 0.13309159874916077, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.09743928164243698)) <= 0.0 + 1.0e-05 * abs(-0.09743928164243698)
            report "Error detected at cycle 852: out0_0_out expected -0.09743928164243698, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 853
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.08773498237133026)) <= 0.0 + 1.0e-05 * abs(-0.08773498237133026)
            report "Error detected at cycle 853: out0_0_out expected -0.08773498237133026, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.8664875626564026)) <= 0.0 + 1.0e-05 * abs(0.8664875626564026)
            report "Error detected at cycle 855: out0_0_out expected 0.8664875626564026, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 856
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.12673886120319366)) <= 0.0 + 1.0e-05 * abs(-0.12673886120319366)
            report "Error detected at cycle 856: out0_0_out expected -0.12673886120319366, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.1808612197637558)) <= 0.0 + 1.0e-05 * abs(-0.1808612197637558)
            report "Error detected at cycle 859: out0_0_out expected -0.1808612197637558, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.11387381702661514)) <= 0.0 + 1.0e-05 * abs(-0.11387381702661514)
            report "Error detected at cycle 863: out0_0_out expected -0.11387381702661514, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 864
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.056816041469573975)) <= 0.0 + 1.0e-05 * abs(-0.056816041469573975)
            report "Error detected at cycle 864: out0_0_out expected -0.056816041469573975, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.10088717192411423)) <= 0.0 + 1.0e-05 * abs(-0.10088717192411423)
            report "Error detected at cycle 866: out0_0_out expected -0.10088717192411423, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.04933243989944458)) <= 0.0 + 1.0e-05 * abs(0.04933243989944458)
            report "Error detected at cycle 869: out0_0_out expected 0.04933243989944458, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.3486635982990265)) <= 0.0 + 1.0e-05 * abs(-0.3486635982990265)
            report "Error detected at cycle 873: out0_0_out expected -0.3486635982990265, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 874
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.13691915571689606)) <= 0.0 + 1.0e-05 * abs(-0.13691915571689606)
            report "Error detected at cycle 874: out0_0_out expected -0.13691915571689606, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.023970836773514748)) <= 0.0 + 1.0e-05 * abs(0.023970836773514748)
            report "Error detected at cycle 876: out0_0_out expected 0.023970836773514748, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.044381704181432724)) <= 0.0 + 1.0e-05 * abs(-0.044381704181432724)
            report "Error detected at cycle 878: out0_0_out expected -0.044381704181432724, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.10683455318212509)) <= 0.0 + 1.0e-05 * abs(-0.10683455318212509)
            report "Error detected at cycle 882: out0_0_out expected -0.10683455318212509, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.12928462028503418)) <= 0.0 + 1.0e-05 * abs(0.12928462028503418)
            report "Error detected at cycle 884: out0_0_out expected 0.12928462028503418, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.8280317783355713)) <= 0.0 + 1.0e-05 * abs(0.8280317783355713)
            report "Error detected at cycle 886: out0_0_out expected 0.8280317783355713, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 887
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.033007219433784485)) <= 0.0 + 1.0e-05 * abs(-0.033007219433784485)
            report "Error detected at cycle 887: out0_0_out expected -0.033007219433784485, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.031012192368507385)) <= 0.0 + 1.0e-05 * abs(0.031012192368507385)
            report "Error detected at cycle 890: out0_0_out expected 0.031012192368507385, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 891
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.1656889170408249)) <= 0.0 + 1.0e-05 * abs(-0.1656889170408249)
            report "Error detected at cycle 891: out0_0_out expected -0.1656889170408249, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 892
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.0059214625507593155)) <= 0.0 + 1.0e-05 * abs(-0.0059214625507593155)
            report "Error detected at cycle 892: out0_0_out expected -0.0059214625507593155, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.2086651623249054)) <= 0.0 + 1.0e-05 * abs(0.2086651623249054)
            report "Error detected at cycle 896: out0_0_out expected 0.2086651623249054, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 897
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.043869540095329285)) <= 0.0 + 1.0e-05 * abs(-0.043869540095329285)
            report "Error detected at cycle 897: out0_0_out expected -0.043869540095329285, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 898
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.13278943300247192)) <= 0.0 + 1.0e-05 * abs(-0.13278943300247192)
            report "Error detected at cycle 898: out0_0_out expected -0.13278943300247192, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.1919882595539093)) <= 0.0 + 1.0e-05 * abs(0.1919882595539093)
            report "Error detected at cycle 902: out0_0_out expected 0.1919882595539093, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.02912379615008831)) <= 0.0 + 1.0e-05 * abs(0.02912379615008831)
            report "Error detected at cycle 904: out0_0_out expected 0.02912379615008831, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 905
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.6109279990196228)) <= 0.0 + 1.0e-05 * abs(0.6109279990196228)
            report "Error detected at cycle 905: out0_0_out expected 0.6109279990196228, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.16041617095470428)) <= 0.0 + 1.0e-05 * abs(-0.16041617095470428)
            report "Error detected at cycle 907: out0_0_out expected -0.16041617095470428, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.2262117564678192)) <= 0.0 + 1.0e-05 * abs(-0.2262117564678192)
            report "Error detected at cycle 909: out0_0_out expected -0.2262117564678192, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.015325754880905151)) <= 0.0 + 1.0e-05 * abs(-0.015325754880905151)
            report "Error detected at cycle 913: out0_0_out expected -0.015325754880905151, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 914
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.14532886445522308)) <= 0.0 + 1.0e-05 * abs(-0.14532886445522308)
            report "Error detected at cycle 914: out0_0_out expected -0.14532886445522308, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.14923670887947083)) <= 0.0 + 1.0e-05 * abs(0.14923670887947083)
            report "Error detected at cycle 918: out0_0_out expected 0.14923670887947083, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.7417508363723755)) <= 0.0 + 1.0e-05 * abs(0.7417508363723755)
            report "Error detected at cycle 921: out0_0_out expected 0.7417508363723755, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.07983817905187607)) <= 0.0 + 1.0e-05 * abs(0.07983817905187607)
            report "Error detected at cycle 923: out0_0_out expected 0.07983817905187607, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.1771831214427948)) <= 0.0 + 1.0e-05 * abs(-0.1771831214427948)
            report "Error detected at cycle 930: out0_0_out expected -0.1771831214427948, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.6358357071876526)) <= 0.0 + 1.0e-05 * abs(0.6358357071876526)
            report "Error detected at cycle 938: out0_0_out expected 0.6358357071876526, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
