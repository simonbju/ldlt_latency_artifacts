...
begin
    ...
    begin
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.667209804058075)) <= 0.0 + 1.0e-05 * abs(0.667209804058075)
            report "Error detected at cycle 724: out0_0_out expected 0.667209804058075, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.6358357071876526)) <= 0.0 + 1.0e-05 * abs(0.6358357071876526)
            report "Error detected at cycle 935: out0_0_out expected 0.6358357071876526, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 936
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.1453288495540619)) <= 0.0 + 1.0e-05 * abs(-0.1453288495540619)
            report "Error detected at cycle 936: out0_0_out expected -0.1453288495540619, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 937
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.1771831065416336)) <= 0.0 + 1.0e-05 * abs(-0.1771831065416336)
            report "Error detected at cycle 937: out0_0_out expected -0.1771831065416336, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 938
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.07983815670013428)) <= 0.0 + 1.0e-05 * abs(0.07983815670013428)
            report "Error detected at cycle 938: out0_0_out expected 0.07983815670013428, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 939
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.14923667907714844)) <= 0.0 + 1.0e-05 * abs(0.14923667907714844)
            report "Error detected at cycle 939: out0_0_out expected 0.14923667907714844, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 940
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.029123807325959206)) <= 0.0 + 1.0e-05 * abs(0.029123807325959206)
            report "Error detected at cycle 940: out0_0_out expected 0.029123807325959206, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 941
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.22621166706085205)) <= 0.0 + 1.0e-05 * abs(-0.22621166706085205)
            report "Error detected at cycle 941: out0_0_out expected -0.22621166706085205, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 942
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.7417508363723755)) <= 0.0 + 1.0e-05 * abs(0.7417508363723755)
            report "Error detected at cycle 942: out0_0_out expected 0.7417508363723755, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 943
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.1327894628047943)) <= 0.0 + 1.0e-05 * abs(-0.1327894628047943)
            report "Error detected at cycle 943: out0_0_out expected -0.1327894628047943, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 944
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.005921449512243271)) <= 0.0 + 1.0e-05 * abs(-0.005921449512243271)
            report "Error detected at cycle 944: out0_0_out expected -0.005921449512243271, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 945
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.044381700456142426)) <= 0.0 + 1.0e-05 * abs(-0.044381700456142426)
            report "Error detected at cycle 945: out0_0_out expected -0.044381700456142426, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 946
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.015325775370001793)) <= 0.0 + 1.0e-05 * abs(-0.015325775370001793)
            report "Error detected at cycle 946: out0_0_out expected -0.015325775370001793, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 947
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.1079598143696785)) <= 0.0 + 1.0e-05 * abs(-0.1079598143696785)
            report "Error detected at cycle 947: out0_0_out expected -0.1079598143696785, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 948
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.0023358725011348724)) <= 0.0 + 1.0e-05 * abs(-0.0023358725011348724)
            report "Error detected at cycle 948: out0_0_out expected -0.0023358725011348724, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 949
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.13691911101341248)) <= 0.0 + 1.0e-05 * abs(-0.13691911101341248)
            report "Error detected at cycle 949: out0_0_out expected -0.13691911101341248, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 950
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.04386955872178078)) <= 0.0 + 1.0e-05 * abs(-0.04386955872178078)
            report "Error detected at cycle 950: out0_0_out expected -0.04386955872178078, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 951
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.6109281182289124)) <= 0.0 + 1.0e-05 * abs(0.6109281182289124)
            report "Error detected at cycle 951: out0_0_out expected 0.6109281182289124, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 952
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.03101220540702343)) <= 0.0 + 1.0e-05 * abs(0.03101220540702343)
            report "Error detected at cycle 952: out0_0_out expected 0.03101220540702343, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 953
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.1068345308303833)) <= 0.0 + 1.0e-05 * abs(-0.1068345308303833)
            report "Error detected at cycle 953: out0_0_out expected -0.1068345308303833, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 954
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.3486636281013489)) <= 0.0 + 1.0e-05 * abs(-0.3486636281013489)
            report "Error detected at cycle 954: out0_0_out expected -0.3486636281013489, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 955
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.8280317783355713)) <= 0.0 + 1.0e-05 * abs(0.8280317783355713)
            report "Error detected at cycle 955: out0_0_out expected 0.8280317783355713, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 956
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.8664875626564026)) <= 0.0 + 1.0e-05 * abs(0.8664875626564026)
            report "Error detected at cycle 956: out0_0_out expected 0.8664875626564026, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 957
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.11387378722429276)) <= 0.0 + 1.0e-05 * abs(-0.11387378722429276)
            report "Error detected at cycle 957: out0_0_out expected -0.11387378722429276, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 958
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.20743320882320404)) <= 0.0 + 1.0e-05 * abs(0.20743320882320404)
            report "Error detected at cycle 958: out0_0_out expected 0.20743320882320404, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 959
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.014418983832001686)) <= 0.0 + 1.0e-05 * abs(-0.014418983832001686)
            report "Error detected at cycle 959: out0_0_out expected -0.014418983832001686, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 960
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.5708497762680054)) <= 0.0 + 1.0e-05 * abs(0.5708497762680054)
            report "Error detected at cycle 960: out0_0_out expected 0.5708497762680054, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 961
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.2297528088092804)) <= 0.0 + 1.0e-05 * abs(-0.2297528088092804)
            report "Error detected at cycle 961: out0_0_out expected -0.2297528088092804, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 962
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.03399326279759407)) <= 0.0 + 1.0e-05 * abs(0.03399326279759407)
            report "Error detected at cycle 962: out0_0_out expected 0.03399326279759407, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 963
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.6682534217834473)) <= 0.0 + 1.0e-05 * abs(0.6682534217834473)
            report "Error detected at cycle 963: out0_0_out expected 0.6682534217834473, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 964
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.01544215902686119)) <= 0.0 + 1.0e-05 * abs(0.01544215902686119)
            report "Error detected at cycle 964: out0_0_out expected 0.01544215902686119, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 965
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.049030743539333344)) <= 0.0 + 1.0e-05 * abs(-0.049030743539333344)
            report "Error detected at cycle 965: out0_0_out expected -0.049030743539333344, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 966
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.9502374529838562)) <= 0.0 + 1.0e-05 * abs(0.9502374529838562)
            report "Error detected at cycle 966: out0_0_out expected 0.9502374529838562, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 967
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.04851575195789337)) <= 0.0 + 1.0e-05 * abs(0.04851575195789337)
            report "Error detected at cycle 967: out0_0_out expected 0.04851575195789337, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 968
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.056816041469573975)) <= 0.0 + 1.0e-05 * abs(-0.056816041469573975)
            report "Error detected at cycle 968: out0_0_out expected -0.056816041469573975, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 969
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.02026849240064621)) <= 0.0 + 1.0e-05 * abs(-0.02026849240064621)
            report "Error detected at cycle 969: out0_0_out expected -0.02026849240064621, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 970
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.03877268731594086)) <= 0.0 + 1.0e-05 * abs(-0.03877268731594086)
            report "Error detected at cycle 970: out0_0_out expected -0.03877268731594086, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 971
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.0070041026920080185)) <= 0.0 + 1.0e-05 * abs(0.0070041026920080185)
            report "Error detected at cycle 971: out0_0_out expected 0.0070041026920080185, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 972
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.5250608325004578)) <= 0.0 + 1.0e-05 * abs(0.5250608325004578)
            report "Error detected at cycle 972: out0_0_out expected 0.5250608325004578, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 973
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.17430880665779114)) <= 0.0 + 1.0e-05 * abs(-0.17430880665779114)
            report "Error detected at cycle 973: out0_0_out expected -0.17430880665779114, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 974
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.08773497492074966)) <= 0.0 + 1.0e-05 * abs(-0.08773497492074966)
            report "Error detected at cycle 974: out0_0_out expected -0.08773497492074966, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 975
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.02206876315176487)) <= 0.0 + 1.0e-05 * abs(-0.02206876315176487)
            report "Error detected at cycle 975: out0_0_out expected -0.02206876315176487, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 976
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.04743529483675957)) <= 0.0 + 1.0e-05 * abs(0.04743529483675957)
            report "Error detected at cycle 976: out0_0_out expected 0.04743529483675957, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 977
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.5832412242889404)) <= 0.0 + 1.0e-05 * abs(0.5832412242889404)
            report "Error detected at cycle 977: out0_0_out expected 0.5832412242889404, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 978
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.008170686662197113)) <= 0.0 + 1.0e-05 * abs(-0.008170686662197113)
            report "Error detected at cycle 978: out0_0_out expected -0.008170686662197113, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 979
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.048157572746276855)) <= 0.0 + 1.0e-05 * abs(-0.048157572746276855)
            report "Error detected at cycle 979: out0_0_out expected -0.048157572746276855, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 980
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.4887613356113434)) <= 0.0 + 1.0e-05 * abs(0.4887613356113434)
            report "Error detected at cycle 980: out0_0_out expected 0.4887613356113434, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 981
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.02187284082174301)) <= 0.0 + 1.0e-05 * abs(-0.02187284082174301)
            report "Error detected at cycle 981: out0_0_out expected -0.02187284082174301, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 982
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.027070319280028343)) <= 0.0 + 1.0e-05 * abs(-0.027070319280028343)
            report "Error detected at cycle 982: out0_0_out expected -0.027070319280028343, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 983
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.5998501181602478)) <= 0.0 + 1.0e-05 * abs(0.5998501181602478)
            report "Error detected at cycle 983: out0_0_out expected 0.5998501181602478, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 984
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.23289696872234344)) <= 0.0 + 1.0e-05 * abs(-0.23289696872234344)
            report "Error detected at cycle 984: out0_0_out expected -0.23289696872234344, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 985
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.8149998784065247)) <= 0.0 + 1.0e-05 * abs(0.8149998784065247)
            report "Error detected at cycle 985: out0_0_out expected 0.8149998784065247, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 986
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.05222167819738388)) <= 0.0 + 1.0e-05 * abs(0.05222167819738388)
            report "Error detected at cycle 986: out0_0_out expected 0.05222167819738388, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 987
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.09743928909301758)) <= 0.0 + 1.0e-05 * abs(-0.09743928909301758)
            report "Error detected at cycle 987: out0_0_out expected -0.09743928909301758, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 988
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.10327304899692535)) <= 0.0 + 1.0e-05 * abs(0.10327304899692535)
            report "Error detected at cycle 988: out0_0_out expected 0.10327304899692535, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 989
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.07310181856155396)) <= 0.0 + 1.0e-05 * abs(-0.07310181856155396)
            report "Error detected at cycle 989: out0_0_out expected -0.07310181856155396, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 990
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.07640542834997177)) <= 0.0 + 1.0e-05 * abs(-0.07640542834997177)
            report "Error detected at cycle 990: out0_0_out expected -0.07640542834997177, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 991
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.03300721198320389)) <= 0.0 + 1.0e-05 * abs(-0.03300721198320389)
            report "Error detected at cycle 991: out0_0_out expected -0.03300721198320389, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 992
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.05360947921872139)) <= 0.0 + 1.0e-05 * abs(0.05360947921872139)
            report "Error detected at cycle 992: out0_0_out expected 0.05360947921872139, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 993
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.04822874441742897)) <= 0.0 + 1.0e-05 * abs(0.04822874441742897)
            report "Error detected at cycle 993: out0_0_out expected 0.04822874441742897, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 994
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.062438689172267914)) <= 0.0 + 1.0e-05 * abs(0.062438689172267914)
            report "Error detected at cycle 994: out0_0_out expected 0.062438689172267914, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 995
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.13416257500648499)) <= 0.0 + 1.0e-05 * abs(-0.13416257500648499)
            report "Error detected at cycle 995: out0_0_out expected -0.13416257500648499, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 996
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.7447477579116821)) <= 0.0 + 1.0e-05 * abs(0.7447477579116821)
            report "Error detected at cycle 996: out0_0_out expected 0.7447477579116821, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 997
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.029970936477184296)) <= 0.0 + 1.0e-05 * abs(-0.029970936477184296)
            report "Error detected at cycle 997: out0_0_out expected -0.029970936477184296, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 998
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.027921006083488464)) <= 0.0 + 1.0e-05 * abs(-0.027921006083488464)
            report "Error detected at cycle 998: out0_0_out expected -0.027921006083488464, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 999
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.009396040812134743)) <= 0.0 + 1.0e-05 * abs(-0.009396040812134743)
            report "Error detected at cycle 999: out0_0_out expected -0.009396040812134743, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1000
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.03441109135746956)) <= 0.0 + 1.0e-05 * abs(0.03441109135746956)
            report "Error detected at cycle 1000: out0_0_out expected 0.03441109135746956, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1001
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.012657810002565384)) <= 0.0 + 1.0e-05 * abs(0.012657810002565384)
            report "Error detected at cycle 1001: out0_0_out expected 0.012657810002565384, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1002
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.13164183497428894)) <= 0.0 + 1.0e-05 * abs(-0.13164183497428894)
            report "Error detected at cycle 1002: out0_0_out expected -0.13164183497428894, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1003
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.13517224788665771)) <= 0.0 + 1.0e-05 * abs(-0.13517224788665771)
            report "Error detected at cycle 1003: out0_0_out expected -0.13517224788665771, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1004
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.2874801754951477)) <= 0.0 + 1.0e-05 * abs(-0.2874801754951477)
            report "Error detected at cycle 1004: out0_0_out expected -0.2874801754951477, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1005
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.07240854203701019)) <= 0.0 + 1.0e-05 * abs(-0.07240854203701019)
            report "Error detected at cycle 1005: out0_0_out expected -0.07240854203701019, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1006
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.0031853141263127327)) <= 0.0 + 1.0e-05 * abs(0.0031853141263127327)
            report "Error detected at cycle 1006: out0_0_out expected 0.0031853141263127327, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1007
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.038455765694379807)) <= 0.0 + 1.0e-05 * abs(0.038455765694379807)
            report "Error detected at cycle 1007: out0_0_out expected 0.038455765694379807, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1008
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.03533279150724411)) <= 0.0 + 1.0e-05 * abs(-0.03533279150724411)
            report "Error detected at cycle 1008: out0_0_out expected -0.03533279150724411, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1009
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.23986513912677765)) <= 0.0 + 1.0e-05 * abs(-0.23986513912677765)
            report "Error detected at cycle 1009: out0_0_out expected -0.23986513912677765, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1010
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.039249349385499954)) <= 0.0 + 1.0e-05 * abs(0.039249349385499954)
            report "Error detected at cycle 1010: out0_0_out expected 0.039249349385499954, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1011
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.13752800226211548)) <= 0.0 + 1.0e-05 * abs(-0.13752800226211548)
            report "Error detected at cycle 1011: out0_0_out expected -0.13752800226211548, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1012
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.06502603739500046)) <= 0.0 + 1.0e-05 * abs(-0.06502603739500046)
            report "Error detected at cycle 1012: out0_0_out expected -0.06502603739500046, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1013
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.0827391967177391)) <= 0.0 + 1.0e-05 * abs(-0.0827391967177391)
            report "Error detected at cycle 1013: out0_0_out expected -0.0827391967177391, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1014
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.1454460322856903)) <= 0.0 + 1.0e-05 * abs(0.1454460322856903)
            report "Error detected at cycle 1014: out0_0_out expected 0.1454460322856903, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1015
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.26348504424095154)) <= 0.0 + 1.0e-05 * abs(-0.26348504424095154)
            report "Error detected at cycle 1015: out0_0_out expected -0.26348504424095154, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1016
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.0752321183681488)) <= 0.0 + 1.0e-05 * abs(-0.0752321183681488)
            report "Error detected at cycle 1016: out0_0_out expected -0.0752321183681488, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1017
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.06804810464382172)) <= 0.0 + 1.0e-05 * abs(0.06804810464382172)
            report "Error detected at cycle 1017: out0_0_out expected 0.06804810464382172, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1018
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.09702010452747345)) <= 0.0 + 1.0e-05 * abs(0.09702010452747345)
            report "Error detected at cycle 1018: out0_0_out expected 0.09702010452747345, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1019
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.01391404028981924)) <= 0.0 + 1.0e-05 * abs(0.01391404028981924)
            report "Error detected at cycle 1019: out0_0_out expected 0.01391404028981924, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1020
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.039429374039173126)) <= 0.0 + 1.0e-05 * abs(-0.039429374039173126)
            report "Error detected at cycle 1020: out0_0_out expected -0.039429374039173126, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1021
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.007942134514451027)) <= 0.0 + 1.0e-05 * abs(0.007942134514451027)
            report "Error detected at cycle 1021: out0_0_out expected 0.007942134514451027, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1022
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.0931302011013031)) <= 0.0 + 1.0e-05 * abs(-0.0931302011013031)
            report "Error detected at cycle 1022: out0_0_out expected -0.0931302011013031, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1023
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.06466279923915863)) <= 0.0 + 1.0e-05 * abs(-0.06466279923915863)
            report "Error detected at cycle 1023: out0_0_out expected -0.06466279923915863, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1024
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.06992495805025101)) <= 0.0 + 1.0e-05 * abs(-0.06992495805025101)
            report "Error detected at cycle 1024: out0_0_out expected -0.06992495805025101, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1025
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.1754755675792694)) <= 0.0 + 1.0e-05 * abs(-0.1754755675792694)
            report "Error detected at cycle 1025: out0_0_out expected -0.1754755675792694, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1026
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.1013530045747757)) <= 0.0 + 1.0e-05 * abs(-0.1013530045747757)
            report "Error detected at cycle 1026: out0_0_out expected -0.1013530045747757, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1027
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.055800825357437134)) <= 0.0 + 1.0e-05 * abs(0.055800825357437134)
            report "Error detected at cycle 1027: out0_0_out expected 0.055800825357437134, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1028
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.014474610798060894)) <= 0.0 + 1.0e-05 * abs(0.014474610798060894)
            report "Error detected at cycle 1028: out0_0_out expected 0.014474610798060894, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1029
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.10669463872909546)) <= 0.0 + 1.0e-05 * abs(-0.10669463872909546)
            report "Error detected at cycle 1029: out0_0_out expected -0.10669463872909546, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1030
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.14445462822914124)) <= 0.0 + 1.0e-05 * abs(0.14445462822914124)
            report "Error detected at cycle 1030: out0_0_out expected 0.14445462822914124, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1031
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.2084886133670807)) <= 0.0 + 1.0e-05 * abs(-0.2084886133670807)
            report "Error detected at cycle 1031: out0_0_out expected -0.2084886133670807, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1032
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.18194520473480225)) <= 0.0 + 1.0e-05 * abs(-0.18194520473480225)
            report "Error detected at cycle 1032: out0_0_out expected -0.18194520473480225, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1033
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.006356833036988974)) <= 0.0 + 1.0e-05 * abs(0.006356833036988974)
            report "Error detected at cycle 1033: out0_0_out expected 0.006356833036988974, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1034
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.12730124592781067)) <= 0.0 + 1.0e-05 * abs(-0.12730124592781067)
            report "Error detected at cycle 1034: out0_0_out expected -0.12730124592781067, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1035
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.13680602610111237)) <= 0.0 + 1.0e-05 * abs(0.13680602610111237)
            report "Error detected at cycle 1035: out0_0_out expected 0.13680602610111237, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1036
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.21584199368953705)) <= 0.0 + 1.0e-05 * abs(0.21584199368953705)
            report "Error detected at cycle 1036: out0_0_out expected 0.21584199368953705, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1037
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.029979871585965157)) <= 0.0 + 1.0e-05 * abs(-0.029979871585965157)
            report "Error detected at cycle 1037: out0_0_out expected -0.029979871585965157, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1038
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.13064123690128326)) <= 0.0 + 1.0e-05 * abs(-0.13064123690128326)
            report "Error detected at cycle 1038: out0_0_out expected -0.13064123690128326, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1039
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.17057263851165771)) <= 0.0 + 1.0e-05 * abs(-0.17057263851165771)
            report "Error detected at cycle 1039: out0_0_out expected -0.17057263851165771, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1040
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.10012457519769669)) <= 0.0 + 1.0e-05 * abs(0.10012457519769669)
            report "Error detected at cycle 1040: out0_0_out expected 0.10012457519769669, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1041
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.08169203996658325)) <= 0.0 + 1.0e-05 * abs(-0.08169203996658325)
            report "Error detected at cycle 1041: out0_0_out expected -0.08169203996658325, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1042
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.10696084052324295)) <= 0.0 + 1.0e-05 * abs(0.10696084052324295)
            report "Error detected at cycle 1042: out0_0_out expected 0.10696084052324295, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1043
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.0406595841050148)) <= 0.0 + 1.0e-05 * abs(0.0406595841050148)
            report "Error detected at cycle 1043: out0_0_out expected 0.0406595841050148, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1044
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.05277242138981819)) <= 0.0 + 1.0e-05 * abs(-0.05277242138981819)
            report "Error detected at cycle 1044: out0_0_out expected -0.05277242138981819, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1045
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.03961186483502388)) <= 0.0 + 1.0e-05 * abs(0.03961186483502388)
            report "Error detected at cycle 1045: out0_0_out expected 0.03961186483502388, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1046
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.09199579805135727)) <= 0.0 + 1.0e-05 * abs(-0.09199579805135727)
            report "Error detected at cycle 1046: out0_0_out expected -0.09199579805135727, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1047
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.0445082001388073)) <= 0.0 + 1.0e-05 * abs(0.0445082001388073)
            report "Error detected at cycle 1047: out0_0_out expected 0.0445082001388073, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1048
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.13006529211997986)) <= 0.0 + 1.0e-05 * abs(-0.13006529211997986)
            report "Error detected at cycle 1048: out0_0_out expected -0.13006529211997986, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1049
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.03195595741271973)) <= 0.0 + 1.0e-05 * abs(0.03195595741271973)
            report "Error detected at cycle 1049: out0_0_out expected 0.03195595741271973, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1050
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.10311595350503922)) <= 0.0 + 1.0e-05 * abs(-0.10311595350503922)
            report "Error detected at cycle 1050: out0_0_out expected -0.10311595350503922, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1051
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.1604161411523819)) <= 0.0 + 1.0e-05 * abs(-0.1604161411523819)
            report "Error detected at cycle 1051: out0_0_out expected -0.1604161411523819, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1052
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.1919882744550705)) <= 0.0 + 1.0e-05 * abs(0.1919882744550705)
            report "Error detected at cycle 1052: out0_0_out expected 0.1919882744550705, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1053
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.2086651474237442)) <= 0.0 + 1.0e-05 * abs(0.2086651474237442)
            report "Error detected at cycle 1053: out0_0_out expected 0.2086651474237442, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1054
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.16568893194198608)) <= 0.0 + 1.0e-05 * abs(-0.16568893194198608)
            report "Error detected at cycle 1054: out0_0_out expected -0.16568893194198608, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1055
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.12928462028503418)) <= 0.0 + 1.0e-05 * abs(0.12928462028503418)
            report "Error detected at cycle 1055: out0_0_out expected 0.12928462028503418, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1056
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.0239708349108696)) <= 0.0 + 1.0e-05 * abs(0.0239708349108696)
            report "Error detected at cycle 1056: out0_0_out expected 0.0239708349108696, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1057
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.10088717192411423)) <= 0.0 + 1.0e-05 * abs(-0.10088717192411423)
            report "Error detected at cycle 1057: out0_0_out expected -0.10088717192411423, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1058
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.12673884630203247)) <= 0.0 + 1.0e-05 * abs(-0.12673884630203247)
            report "Error detected at cycle 1058: out0_0_out expected -0.12673884630203247, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1059
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.04933242127299309)) <= 0.0 + 1.0e-05 * abs(0.04933242127299309)
            report "Error detected at cycle 1059: out0_0_out expected 0.04933242127299309, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1060
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.18026861548423767)) <= 0.0 + 1.0e-05 * abs(-0.18026861548423767)
            report "Error detected at cycle 1060: out0_0_out expected -0.18026861548423767, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1061
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.1247539073228836)) <= 0.0 + 1.0e-05 * abs(0.1247539073228836)
            report "Error detected at cycle 1061: out0_0_out expected 0.1247539073228836, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1062
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.180861234664917)) <= 0.0 + 1.0e-05 * abs(-0.180861234664917)
            report "Error detected at cycle 1062: out0_0_out expected -0.180861234664917, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1063
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.13309159874916077)) <= 0.0 + 1.0e-05 * abs(0.13309159874916077)
            report "Error detected at cycle 1063: out0_0_out expected 0.13309159874916077, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1064
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.21714012324810028)) <= 0.0 + 1.0e-05 * abs(-0.21714012324810028)
            report "Error detected at cycle 1064: out0_0_out expected -0.21714012324810028, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1065
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.10581439733505249)) <= 0.0 + 1.0e-05 * abs(-0.10581439733505249)
            report "Error detected at cycle 1065: out0_0_out expected -0.10581439733505249, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1066
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.16565842926502228)) <= 0.0 + 1.0e-05 * abs(-0.16565842926502228)
            report "Error detected at cycle 1066: out0_0_out expected -0.16565842926502228, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1067
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.6996414065361023)) <= 0.0 + 1.0e-05 * abs(0.6996414065361023)
            report "Error detected at cycle 1067: out0_0_out expected 0.6996414065361023, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1068
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.05220543593168259)) <= 0.0 + 1.0e-05 * abs(-0.05220543593168259)
            report "Error detected at cycle 1068: out0_0_out expected -0.05220543593168259, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1069
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.13348813354969025)) <= 0.0 + 1.0e-05 * abs(0.13348813354969025)
            report "Error detected at cycle 1069: out0_0_out expected 0.13348813354969025, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
