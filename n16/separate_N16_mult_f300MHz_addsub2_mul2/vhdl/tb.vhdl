...
begin
    ...
    begin
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.667209804058075)) <= 0.0 + 1.0e-05 * abs(0.667209804058075)
            report "Error detected at cycle 997: out0_0_out expected 0.667209804058075, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.6358357071876526)) <= 0.0 + 1.0e-05 * abs(0.6358357071876526)
            report "Error detected at cycle 1389: out0_0_out expected 0.6358357071876526, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1390
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.13309159874916077)) <= 0.0 + 1.0e-05 * abs(0.13309159874916077)
            report "Error detected at cycle 1390: out0_0_out expected 0.13309159874916077, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1391
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.04933242127299309)) <= 0.0 + 1.0e-05 * abs(0.04933242127299309)
            report "Error detected at cycle 1391: out0_0_out expected 0.04933242127299309, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1392
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.044381700456142426)) <= 0.0 + 1.0e-05 * abs(-0.044381700456142426)
            report "Error detected at cycle 1392: out0_0_out expected -0.044381700456142426, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1393
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.1327894628047943)) <= 0.0 + 1.0e-05 * abs(-0.1327894628047943)
            report "Error detected at cycle 1393: out0_0_out expected -0.1327894628047943, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1394
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.029123807325959206)) <= 0.0 + 1.0e-05 * abs(0.029123807325959206)
            report "Error detected at cycle 1394: out0_0_out expected 0.029123807325959206, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1395
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.1453288495540619)) <= 0.0 + 1.0e-05 * abs(-0.1453288495540619)
            report "Error detected at cycle 1395: out0_0_out expected -0.1453288495540619, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1396
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.1771831065416336)) <= 0.0 + 1.0e-05 * abs(-0.1771831065416336)
            report "Error detected at cycle 1396: out0_0_out expected -0.1771831065416336, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1397
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.07983815670013428)) <= 0.0 + 1.0e-05 * abs(0.07983815670013428)
            report "Error detected at cycle 1397: out0_0_out expected 0.07983815670013428, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1398
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.14923667907714844)) <= 0.0 + 1.0e-05 * abs(0.14923667907714844)
            report "Error detected at cycle 1398: out0_0_out expected 0.14923667907714844, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1399
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.22621166706085205)) <= 0.0 + 1.0e-05 * abs(-0.22621166706085205)
            report "Error detected at cycle 1399: out0_0_out expected -0.22621166706085205, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1400
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.005921449512243271)) <= 0.0 + 1.0e-05 * abs(-0.005921449512243271)
            report "Error detected at cycle 1400: out0_0_out expected -0.005921449512243271, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1401
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.03300721198320389)) <= 0.0 + 1.0e-05 * abs(-0.03300721198320389)
            report "Error detected at cycle 1401: out0_0_out expected -0.03300721198320389, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1402
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.180861234664917)) <= 0.0 + 1.0e-05 * abs(-0.180861234664917)
            report "Error detected at cycle 1402: out0_0_out expected -0.180861234664917, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1403
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.05220543593168259)) <= 0.0 + 1.0e-05 * abs(-0.05220543593168259)
            report "Error detected at cycle 1403: out0_0_out expected -0.05220543593168259, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1404
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.7417508363723755)) <= 0.0 + 1.0e-05 * abs(0.7417508363723755)
            report "Error detected at cycle 1404: out0_0_out expected 0.7417508363723755, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1405
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.1247539073228836)) <= 0.0 + 1.0e-05 * abs(0.1247539073228836)
            report "Error detected at cycle 1405: out0_0_out expected 0.1247539073228836, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1406
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.12673884630203247)) <= 0.0 + 1.0e-05 * abs(-0.12673884630203247)
            report "Error detected at cycle 1406: out0_0_out expected -0.12673884630203247, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1407
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.0239708349108696)) <= 0.0 + 1.0e-05 * abs(0.0239708349108696)
            report "Error detected at cycle 1407: out0_0_out expected 0.0239708349108696, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1408
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.16568893194198608)) <= 0.0 + 1.0e-05 * abs(-0.16568893194198608)
            report "Error detected at cycle 1408: out0_0_out expected -0.16568893194198608, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1409
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.1919882744550705)) <= 0.0 + 1.0e-05 * abs(0.1919882744550705)
            report "Error detected at cycle 1409: out0_0_out expected 0.1919882744550705, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1410
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.015325775370001793)) <= 0.0 + 1.0e-05 * abs(-0.015325775370001793)
            report "Error detected at cycle 1410: out0_0_out expected -0.015325775370001793, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1411
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.006356833036988974)) <= 0.0 + 1.0e-05 * abs(0.006356833036988974)
            report "Error detected at cycle 1411: out0_0_out expected 0.006356833036988974, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1412
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.048157572746276855)) <= 0.0 + 1.0e-05 * abs(-0.048157572746276855)
            report "Error detected at cycle 1412: out0_0_out expected -0.048157572746276855, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1413
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.0023358725011348724)) <= 0.0 + 1.0e-05 * abs(-0.0023358725011348724)
            report "Error detected at cycle 1413: out0_0_out expected -0.0023358725011348724, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1414
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.056816041469573975)) <= 0.0 + 1.0e-05 * abs(-0.056816041469573975)
            report "Error detected at cycle 1414: out0_0_out expected -0.056816041469573975, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1415
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.13691911101341248)) <= 0.0 + 1.0e-05 * abs(-0.13691911101341248)
            report "Error detected at cycle 1415: out0_0_out expected -0.13691911101341248, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1416
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.04386955872178078)) <= 0.0 + 1.0e-05 * abs(-0.04386955872178078)
            report "Error detected at cycle 1416: out0_0_out expected -0.04386955872178078, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1417
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.6109281182289124)) <= 0.0 + 1.0e-05 * abs(0.6109281182289124)
            report "Error detected at cycle 1417: out0_0_out expected 0.6109281182289124, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1418
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.03101220540702343)) <= 0.0 + 1.0e-05 * abs(0.03101220540702343)
            report "Error detected at cycle 1418: out0_0_out expected 0.03101220540702343, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1419
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.1068345308303833)) <= 0.0 + 1.0e-05 * abs(-0.1068345308303833)
            report "Error detected at cycle 1419: out0_0_out expected -0.1068345308303833, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1420
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.08773497492074966)) <= 0.0 + 1.0e-05 * abs(-0.08773497492074966)
            report "Error detected at cycle 1420: out0_0_out expected -0.08773497492074966, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1421
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.09743928909301758)) <= 0.0 + 1.0e-05 * abs(-0.09743928909301758)
            report "Error detected at cycle 1421: out0_0_out expected -0.09743928909301758, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1422
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.3486636281013489)) <= 0.0 + 1.0e-05 * abs(-0.3486636281013489)
            report "Error detected at cycle 1422: out0_0_out expected -0.3486636281013489, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1423
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.8280317783355713)) <= 0.0 + 1.0e-05 * abs(0.8280317783355713)
            report "Error detected at cycle 1423: out0_0_out expected 0.8280317783355713, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1424
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.8664875626564026)) <= 0.0 + 1.0e-05 * abs(0.8664875626564026)
            report "Error detected at cycle 1424: out0_0_out expected 0.8664875626564026, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1425
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.11387378722429276)) <= 0.0 + 1.0e-05 * abs(-0.11387378722429276)
            report "Error detected at cycle 1425: out0_0_out expected -0.11387378722429276, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1426
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.10327304899692535)) <= 0.0 + 1.0e-05 * abs(0.10327304899692535)
            report "Error detected at cycle 1426: out0_0_out expected 0.10327304899692535, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1427
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.03877268731594086)) <= 0.0 + 1.0e-05 * abs(-0.03877268731594086)
            report "Error detected at cycle 1427: out0_0_out expected -0.03877268731594086, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1428
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.20743320882320404)) <= 0.0 + 1.0e-05 * abs(0.20743320882320404)
            report "Error detected at cycle 1428: out0_0_out expected 0.20743320882320404, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1429
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.014418983832001686)) <= 0.0 + 1.0e-05 * abs(-0.014418983832001686)
            report "Error detected at cycle 1429: out0_0_out expected -0.014418983832001686, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1430
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.5708497762680054)) <= 0.0 + 1.0e-05 * abs(0.5708497762680054)
            report "Error detected at cycle 1430: out0_0_out expected 0.5708497762680054, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1431
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.1079598143696785)) <= 0.0 + 1.0e-05 * abs(-0.1079598143696785)
            report "Error detected at cycle 1431: out0_0_out expected -0.1079598143696785, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1432
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.03399326279759407)) <= 0.0 + 1.0e-05 * abs(0.03399326279759407)
            report "Error detected at cycle 1432: out0_0_out expected 0.03399326279759407, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1433
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.2297528088092804)) <= 0.0 + 1.0e-05 * abs(-0.2297528088092804)
            report "Error detected at cycle 1433: out0_0_out expected -0.2297528088092804, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1434
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.6682534217834473)) <= 0.0 + 1.0e-05 * abs(0.6682534217834473)
            report "Error detected at cycle 1434: out0_0_out expected 0.6682534217834473, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1435
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.05360947921872139)) <= 0.0 + 1.0e-05 * abs(0.05360947921872139)
            report "Error detected at cycle 1435: out0_0_out expected 0.05360947921872139, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1436
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.23986513912677765)) <= 0.0 + 1.0e-05 * abs(-0.23986513912677765)
            report "Error detected at cycle 1436: out0_0_out expected -0.23986513912677765, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1437
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.01544215902686119)) <= 0.0 + 1.0e-05 * abs(0.01544215902686119)
            report "Error detected at cycle 1437: out0_0_out expected 0.01544215902686119, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1438
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.049030743539333344)) <= 0.0 + 1.0e-05 * abs(-0.049030743539333344)
            report "Error detected at cycle 1438: out0_0_out expected -0.049030743539333344, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1439
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.9502374529838562)) <= 0.0 + 1.0e-05 * abs(0.9502374529838562)
            report "Error detected at cycle 1439: out0_0_out expected 0.9502374529838562, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1440
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.07240854203701019)) <= 0.0 + 1.0e-05 * abs(-0.07240854203701019)
            report "Error detected at cycle 1440: out0_0_out expected -0.07240854203701019, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1441
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.02026849240064621)) <= 0.0 + 1.0e-05 * abs(-0.02026849240064621)
            report "Error detected at cycle 1441: out0_0_out expected -0.02026849240064621, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1442
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.04851575195789337)) <= 0.0 + 1.0e-05 * abs(0.04851575195789337)
            report "Error detected at cycle 1442: out0_0_out expected 0.04851575195789337, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1443
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.0070041026920080185)) <= 0.0 + 1.0e-05 * abs(0.0070041026920080185)
            report "Error detected at cycle 1443: out0_0_out expected 0.0070041026920080185, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1444
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.02206876315176487)) <= 0.0 + 1.0e-05 * abs(-0.02206876315176487)
            report "Error detected at cycle 1444: out0_0_out expected -0.02206876315176487, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1445
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.5250608325004578)) <= 0.0 + 1.0e-05 * abs(0.5250608325004578)
            report "Error detected at cycle 1445: out0_0_out expected 0.5250608325004578, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1446
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.17430880665779114)) <= 0.0 + 1.0e-05 * abs(-0.17430880665779114)
            report "Error detected at cycle 1446: out0_0_out expected -0.17430880665779114, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1447
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.04743529483675957)) <= 0.0 + 1.0e-05 * abs(0.04743529483675957)
            report "Error detected at cycle 1447: out0_0_out expected 0.04743529483675957, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1448
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.5832412242889404)) <= 0.0 + 1.0e-05 * abs(0.5832412242889404)
            report "Error detected at cycle 1448: out0_0_out expected 0.5832412242889404, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1449
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.008170686662197113)) <= 0.0 + 1.0e-05 * abs(-0.008170686662197113)
            report "Error detected at cycle 1449: out0_0_out expected -0.008170686662197113, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1450
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.4887613356113434)) <= 0.0 + 1.0e-05 * abs(0.4887613356113434)
            report "Error detected at cycle 1450: out0_0_out expected 0.4887613356113434, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1451
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.02187284082174301)) <= 0.0 + 1.0e-05 * abs(-0.02187284082174301)
            report "Error detected at cycle 1451: out0_0_out expected -0.02187284082174301, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1452
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.027070319280028343)) <= 0.0 + 1.0e-05 * abs(-0.027070319280028343)
            report "Error detected at cycle 1452: out0_0_out expected -0.027070319280028343, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1453
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.5998501181602478)) <= 0.0 + 1.0e-05 * abs(0.5998501181602478)
            report "Error detected at cycle 1453: out0_0_out expected 0.5998501181602478, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1454
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.23289696872234344)) <= 0.0 + 1.0e-05 * abs(-0.23289696872234344)
            report "Error detected at cycle 1454: out0_0_out expected -0.23289696872234344, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1455
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.8149998784065247)) <= 0.0 + 1.0e-05 * abs(0.8149998784065247)
            report "Error detected at cycle 1455: out0_0_out expected 0.8149998784065247, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1456
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.05222167819738388)) <= 0.0 + 1.0e-05 * abs(0.05222167819738388)
            report "Error detected at cycle 1456: out0_0_out expected 0.05222167819738388, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1457
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.07310181856155396)) <= 0.0 + 1.0e-05 * abs(-0.07310181856155396)
            report "Error detected at cycle 1457: out0_0_out expected -0.07310181856155396, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1458
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.07640542834997177)) <= 0.0 + 1.0e-05 * abs(-0.07640542834997177)
            report "Error detected at cycle 1458: out0_0_out expected -0.07640542834997177, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1459
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.04822874441742897)) <= 0.0 + 1.0e-05 * abs(0.04822874441742897)
            report "Error detected at cycle 1459: out0_0_out expected 0.04822874441742897, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1460
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.062438689172267914)) <= 0.0 + 1.0e-05 * abs(0.062438689172267914)
            report "Error detected at cycle 1460: out0_0_out expected 0.062438689172267914, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1461
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.13416257500648499)) <= 0.0 + 1.0e-05 * abs(-0.13416257500648499)
            report "Error detected at cycle 1461: out0_0_out expected -0.13416257500648499, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1462
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.7447477579116821)) <= 0.0 + 1.0e-05 * abs(0.7447477579116821)
            report "Error detected at cycle 1462: out0_0_out expected 0.7447477579116821, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1463
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.029970936477184296)) <= 0.0 + 1.0e-05 * abs(-0.029970936477184296)
            report "Error detected at cycle 1463: out0_0_out expected -0.029970936477184296, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1464
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.027921006083488464)) <= 0.0 + 1.0e-05 * abs(-0.027921006083488464)
            report "Error detected at cycle 1464: out0_0_out expected -0.027921006083488464, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1465
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.009396040812134743)) <= 0.0 + 1.0e-05 * abs(-0.009396040812134743)
            report "Error detected at cycle 1465: out0_0_out expected -0.009396040812134743, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1466
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.03441109135746956)) <= 0.0 + 1.0e-05 * abs(0.03441109135746956)
            report "Error detected at cycle 1466: out0_0_out expected 0.03441109135746956, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1467
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.012657810002565384)) <= 0.0 + 1.0e-05 * abs(0.012657810002565384)
            report "Error detected at cycle 1467: out0_0_out expected 0.012657810002565384, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1468
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.13164183497428894)) <= 0.0 + 1.0e-05 * abs(-0.13164183497428894)
            report "Error detected at cycle 1468: out0_0_out expected -0.13164183497428894, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1469
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.13517224788665771)) <= 0.0 + 1.0e-05 * abs(-0.13517224788665771)
            report "Error detected at cycle 1469: out0_0_out expected -0.13517224788665771, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1470
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.2874801754951477)) <= 0.0 + 1.0e-05 * abs(-0.2874801754951477)
            report "Error detected at cycle 1470: out0_0_out expected -0.2874801754951477, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1471
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.0031853141263127327)) <= 0.0 + 1.0e-05 * abs(0.0031853141263127327)
            report "Error detected at cycle 1471: out0_0_out expected 0.0031853141263127327, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1472
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.038455765694379807)) <= 0.0 + 1.0e-05 * abs(0.038455765694379807)
            report "Error detected at cycle 1472: out0_0_out expected 0.038455765694379807, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1473
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.03533279150724411)) <= 0.0 + 1.0e-05 * abs(-0.03533279150724411)
            report "Error detected at cycle 1473: out0_0_out expected -0.03533279150724411, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1474
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.039249349385499954)) <= 0.0 + 1.0e-05 * abs(0.039249349385499954)
            report "Error detected at cycle 1474: out0_0_out expected 0.039249349385499954, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1475
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.13752800226211548)) <= 0.0 + 1.0e-05 * abs(-0.13752800226211548)
            report "Error detected at cycle 1475: out0_0_out expected -0.13752800226211548, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1476
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.06502603739500046)) <= 0.0 + 1.0e-05 * abs(-0.06502603739500046)
            report "Error detected at cycle 1476: out0_0_out expected -0.06502603739500046, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1477
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.0827391967177391)) <= 0.0 + 1.0e-05 * abs(-0.0827391967177391)
            report "Error detected at cycle 1477: out0_0_out expected -0.0827391967177391, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1478
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.1454460322856903)) <= 0.0 + 1.0e-05 * abs(0.1454460322856903)
            report "Error detected at cycle 1478: out0_0_out expected 0.1454460322856903, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1479
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.26348504424095154)) <= 0.0 + 1.0e-05 * abs(-0.26348504424095154)
            report "Error detected at cycle 1479: out0_0_out expected -0.26348504424095154, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1480
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.0752321183681488)) <= 0.0 + 1.0e-05 * abs(-0.0752321183681488)
            report "Error detected at cycle 1480: out0_0_out expected -0.0752321183681488, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1481
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.06804810464382172)) <= 0.0 + 1.0e-05 * abs(0.06804810464382172)
            report "Error detected at cycle 1481: out0_0_out expected 0.06804810464382172, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1482
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.09702010452747345)) <= 0.0 + 1.0e-05 * abs(0.09702010452747345)
            report "Error detected at cycle 1482: out0_0_out expected 0.09702010452747345, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1483
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.01391404028981924)) <= 0.0 + 1.0e-05 * abs(0.01391404028981924)
            report "Error detected at cycle 1483: out0_0_out expected 0.01391404028981924, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1484
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.039429374039173126)) <= 0.0 + 1.0e-05 * abs(-0.039429374039173126)
            report "Error detected at cycle 1484: out0_0_out expected -0.039429374039173126, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1485
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.007942134514451027)) <= 0.0 + 1.0e-05 * abs(0.007942134514451027)
            report "Error detected at cycle 1485: out0_0_out expected 0.007942134514451027, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1486
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.0931302011013031)) <= 0.0 + 1.0e-05 * abs(-0.0931302011013031)
            report "Error detected at cycle 1486: out0_0_out expected -0.0931302011013031, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1487
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.06466279923915863)) <= 0.0 + 1.0e-05 * abs(-0.06466279923915863)
            report "Error detected at cycle 1487: out0_0_out expected -0.06466279923915863, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1488
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.06992495805025101)) <= 0.0 + 1.0e-05 * abs(-0.06992495805025101)
            report "Error detected at cycle 1488: out0_0_out expected -0.06992495805025101, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1489
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.1754755675792694)) <= 0.0 + 1.0e-05 * abs(-0.1754755675792694)
            report "Error detected at cycle 1489: out0_0_out expected -0.1754755675792694, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1490
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.1013530045747757)) <= 0.0 + 1.0e-05 * abs(-0.1013530045747757)
            report "Error detected at cycle 1490: out0_0_out expected -0.1013530045747757, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1491
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.055800825357437134)) <= 0.0 + 1.0e-05 * abs(0.055800825357437134)
            report "Error detected at cycle 1491: out0_0_out expected 0.055800825357437134, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1492
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.014474610798060894)) <= 0.0 + 1.0e-05 * abs(0.014474610798060894)
            report "Error detected at cycle 1492: out0_0_out expected 0.014474610798060894, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1493
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.10669463872909546)) <= 0.0 + 1.0e-05 * abs(-0.10669463872909546)
            report "Error detected at cycle 1493: out0_0_out expected -0.10669463872909546, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1494
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.14445462822914124)) <= 0.0 + 1.0e-05 * abs(0.14445462822914124)
            report "Error detected at cycle 1494: out0_0_out expected 0.14445462822914124, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1495
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.2084886133670807)) <= 0.0 + 1.0e-05 * abs(-0.2084886133670807)
            report "Error detected at cycle 1495: out0_0_out expected -0.2084886133670807, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1496
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.18194520473480225)) <= 0.0 + 1.0e-05 * abs(-0.18194520473480225)
            report "Error detected at cycle 1496: out0_0_out expected -0.18194520473480225, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1497
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.12730124592781067)) <= 0.0 + 1.0e-05 * abs(-0.12730124592781067)
            report "Error detected at cycle 1497: out0_0_out expected -0.12730124592781067, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1498
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.13680602610111237)) <= 0.0 + 1.0e-05 * abs(0.13680602610111237)
            report "Error detected at cycle 1498: out0_0_out expected 0.13680602610111237, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1499
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.21584199368953705)) <= 0.0 + 1.0e-05 * abs(0.21584199368953705)
            report "Error detected at cycle 1499: out0_0_out expected 0.21584199368953705, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1500
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.029979871585965157)) <= 0.0 + 1.0e-05 * abs(-0.029979871585965157)
            report "Error detected at cycle 1500: out0_0_out expected -0.029979871585965157, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1501
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.13064123690128326)) <= 0.0 + 1.0e-05 * abs(-0.13064123690128326)
            report "Error detected at cycle 1501: out0_0_out expected -0.13064123690128326, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1502
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.17057263851165771)) <= 0.0 + 1.0e-05 * abs(-0.17057263851165771)
            report "Error detected at cycle 1502: out0_0_out expected -0.17057263851165771, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1503
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.10012457519769669)) <= 0.0 + 1.0e-05 * abs(0.10012457519769669)
            report "Error detected at cycle 1503: out0_0_out expected 0.10012457519769669, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1504
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.08169203996658325)) <= 0.0 + 1.0e-05 * abs(-0.08169203996658325)
            report "Error detected at cycle 1504: out0_0_out expected -0.08169203996658325, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1505
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.10696084052324295)) <= 0.0 + 1.0e-05 * abs(0.10696084052324295)
            report "Error detected at cycle 1505: out0_0_out expected 0.10696084052324295, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1506
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.0406595841050148)) <= 0.0 + 1.0e-05 * abs(0.0406595841050148)
            report "Error detected at cycle 1506: out0_0_out expected 0.0406595841050148, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1507
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.05277242138981819)) <= 0.0 + 1.0e-05 * abs(-0.05277242138981819)
            report "Error detected at cycle 1507: out0_0_out expected -0.05277242138981819, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1508
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.03961186483502388)) <= 0.0 + 1.0e-05 * abs(0.03961186483502388)
            report "Error detected at cycle 1508: out0_0_out expected 0.03961186483502388, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1509
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.09199579805135727)) <= 0.0 + 1.0e-05 * abs(-0.09199579805135727)
            report "Error detected at cycle 1509: out0_0_out expected -0.09199579805135727, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1510
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.0445082001388073)) <= 0.0 + 1.0e-05 * abs(0.0445082001388073)
            report "Error detected at cycle 1510: out0_0_out expected 0.0445082001388073, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1511
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.13006529211997986)) <= 0.0 + 1.0e-05 * abs(-0.13006529211997986)
            report "Error detected at cycle 1511: out0_0_out expected -0.13006529211997986, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1512
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.03195595741271973)) <= 0.0 + 1.0e-05 * abs(0.03195595741271973)
            report "Error detected at cycle 1512: out0_0_out expected 0.03195595741271973, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1513
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.10311595350503922)) <= 0.0 + 1.0e-05 * abs(-0.10311595350503922)
            report "Error detected at cycle 1513: out0_0_out expected -0.10311595350503922, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1514
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.1604161411523819)) <= 0.0 + 1.0e-05 * abs(-0.1604161411523819)
            report "Error detected at cycle 1514: out0_0_out expected -0.1604161411523819, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1515
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.2086651474237442)) <= 0.0 + 1.0e-05 * abs(0.2086651474237442)
            report "Error detected at cycle 1515: out0_0_out expected 0.2086651474237442, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1516
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.12928462028503418)) <= 0.0 + 1.0e-05 * abs(0.12928462028503418)
            report "Error detected at cycle 1516: out0_0_out expected 0.12928462028503418, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.18026861548423767)) <= 0.0 + 1.0e-05 * abs(-0.18026861548423767)
            report "Error detected at cycle 1518: out0_0_out expected -0.18026861548423767, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1519
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.21714012324810028)) <= 0.0 + 1.0e-05 * abs(-0.21714012324810028)
            report "Error detected at cycle 1519: out0_0_out expected -0.21714012324810028, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1520
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.10581439733505249)) <= 0.0 + 1.0e-05 * abs(-0.10581439733505249)
            report "Error detected at cycle 1520: out0_0_out expected -0.10581439733505249, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1521
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.16565842926502228)) <= 0.0 + 1.0e-05 * abs(-0.16565842926502228)
            report "Error detected at cycle 1521: out0_0_out expected -0.16565842926502228, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1522
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.6996414065361023)) <= 0.0 + 1.0e-05 * abs(0.6996414065361023)
            report "Error detected at cycle 1522: out0_0_out expected 0.6996414065361023, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1523
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.13348813354969025)) <= 0.0 + 1.0e-05 * abs(0.13348813354969025)
            report "Error detected at cycle 1523: out0_0_out expected 0.13348813354969025, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
