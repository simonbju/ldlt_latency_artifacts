...
begin
    ...
    begin
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.667209804058075)) <= 0.0 + 1.0e-05 * abs(0.667209804058075)
            report "Error detected at cycle 621: out0_0_out expected 0.667209804058075, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.13006529211997986)) <= 0.0 + 1.0e-05 * abs(-0.13006529211997986)
            report "Error detected at cycle 628: out0_0_out expected -0.13006529211997986, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.044508196413517)) <= 0.0 + 1.0e-05 * abs(0.044508196413517)
            report "Error detected at cycle 643: out0_0_out expected 0.044508196413517, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 644
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.6996414065361023)) <= 0.0 + 1.0e-05 * abs(0.6996414065361023)
            report "Error detected at cycle 644: out0_0_out expected 0.6996414065361023, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.05222167447209358)) <= 0.0 + 1.0e-05 * abs(0.05222167447209358)
            report "Error detected at cycle 658: out0_0_out expected 0.05222167447209358, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 659
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.09199580550193787)) <= 0.0 + 1.0e-05 * abs(-0.09199580550193787)
            report "Error detected at cycle 659: out0_0_out expected -0.09199580550193787, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.07310182601213455)) <= 0.0 + 1.0e-05 * abs(-0.07310182601213455)
            report "Error detected at cycle 673: out0_0_out expected -0.07310182601213455, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 674
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.8149998784065247)) <= 0.0 + 1.0e-05 * abs(0.8149998784065247)
            report "Error detected at cycle 674: out0_0_out expected 0.8149998784065247, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 675
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.03961186483502388)) <= 0.0 + 1.0e-05 * abs(0.03961186483502388)
            report "Error detected at cycle 675: out0_0_out expected 0.03961186483502388, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.23289696872234344)) <= 0.0 + 1.0e-05 * abs(-0.23289696872234344)
            report "Error detected at cycle 688: out0_0_out expected -0.23289696872234344, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 689
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.04822874069213867)) <= 0.0 + 1.0e-05 * abs(0.04822874069213867)
            report "Error detected at cycle 689: out0_0_out expected 0.04822874069213867, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.05277242884039879)) <= 0.0 + 1.0e-05 * abs(-0.05277242884039879)
            report "Error detected at cycle 691: out0_0_out expected -0.05277242884039879, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.027070321142673492)) <= 0.0 + 1.0e-05 * abs(-0.027070321142673492)
            report "Error detected at cycle 703: out0_0_out expected -0.027070321142673492, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 704
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.599850058555603)) <= 0.0 + 1.0e-05 * abs(0.599850058555603)
            report "Error detected at cycle 704: out0_0_out expected 0.599850058555603, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 705
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.034411098808050156)) <= 0.0 + 1.0e-05 * abs(0.034411098808050156)
            report "Error detected at cycle 705: out0_0_out expected 0.034411098808050156, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.0406595841050148)) <= 0.0 + 1.0e-05 * abs(0.0406595841050148)
            report "Error detected at cycle 707: out0_0_out expected 0.0406595841050148, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.02187284082174301)) <= 0.0 + 1.0e-05 * abs(-0.02187284082174301)
            report "Error detected at cycle 718: out0_0_out expected -0.02187284082174301, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 719
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.009396038949489594)) <= 0.0 + 1.0e-05 * abs(-0.009396038949489594)
            report "Error detected at cycle 719: out0_0_out expected -0.009396038949489594, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.13416258990764618)) <= 0.0 + 1.0e-05 * abs(-0.13416258990764618)
            report "Error detected at cycle 721: out0_0_out expected -0.13416258990764618, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.10696083307266235)) <= 0.0 + 1.0e-05 * abs(0.10696083307266235)
            report "Error detected at cycle 726: out0_0_out expected 0.10696083307266235, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.027921007946133614)) <= 0.0 + 1.0e-05 * abs(-0.027921007946133614)
            report "Error detected at cycle 733: out0_0_out expected -0.027921007946133614, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 734
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.4887613356113434)) <= 0.0 + 1.0e-05 * abs(0.4887613356113434)
            report "Error detected at cycle 734: out0_0_out expected 0.4887613356113434, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 735
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.06243869289755821)) <= 0.0 + 1.0e-05 * abs(0.06243869289755821)
            report "Error detected at cycle 735: out0_0_out expected 0.06243869289755821, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.1351722627878189)) <= 0.0 + 1.0e-05 * abs(-0.1351722627878189)
            report "Error detected at cycle 737: out0_0_out expected -0.1351722627878189, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.08169203251600266)) <= 0.0 + 1.0e-05 * abs(-0.08169203251600266)
            report "Error detected at cycle 743: out0_0_out expected -0.08169203251600266, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.029970936477184296)) <= 0.0 + 1.0e-05 * abs(-0.029970936477184296)
            report "Error detected at cycle 748: out0_0_out expected -0.029970936477184296, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 749
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.07640542834997177)) <= 0.0 + 1.0e-05 * abs(-0.07640542834997177)
            report "Error detected at cycle 749: out0_0_out expected -0.07640542834997177, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.13164180517196655)) <= 0.0 + 1.0e-05 * abs(-0.13164180517196655)
            report "Error detected at cycle 751: out0_0_out expected -0.13164180517196655, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.03533279150724411)) <= 0.0 + 1.0e-05 * abs(-0.03533279150724411)
            report "Error detected at cycle 762: out0_0_out expected -0.03533279150724411, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 763
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.7447478175163269)) <= 0.0 + 1.0e-05 * abs(0.7447478175163269)
            report "Error detected at cycle 763: out0_0_out expected 0.7447478175163269, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 764
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.008170685730874538)) <= 0.0 + 1.0e-05 * abs(-0.008170685730874538)
            report "Error detected at cycle 764: out0_0_out expected -0.008170685730874538, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 765
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.012657813727855682)) <= 0.0 + 1.0e-05 * abs(0.012657813727855682)
            report "Error detected at cycle 765: out0_0_out expected 0.012657813727855682, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.047435302287340164)) <= 0.0 + 1.0e-05 * abs(0.047435302287340164)
            report "Error detected at cycle 778: out0_0_out expected 0.047435302287340164, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.02206876315176487)) <= 0.0 + 1.0e-05 * abs(-0.02206876315176487)
            report "Error detected at cycle 781: out0_0_out expected -0.02206876315176487, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.038455765694379807)) <= 0.0 + 1.0e-05 * abs(0.038455765694379807)
            report "Error detected at cycle 786: out0_0_out expected 0.038455765694379807, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.5832412242889404)) <= 0.0 + 1.0e-05 * abs(0.5832412242889404)
            report "Error detected at cycle 793: out0_0_out expected 0.5832412242889404, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 794
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.10012456029653549)) <= 0.0 + 1.0e-05 * abs(0.10012456029653549)
            report "Error detected at cycle 794: out0_0_out expected 0.10012456029653549, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.17430882155895233)) <= 0.0 + 1.0e-05 * abs(-0.17430882155895233)
            report "Error detected at cycle 802: out0_0_out expected -0.17430882155895233, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.003185315988957882)) <= 0.0 + 1.0e-05 * abs(0.003185315988957882)
            report "Error detected at cycle 808: out0_0_out expected 0.003185315988957882, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.0931301936507225)) <= 0.0 + 1.0e-05 * abs(-0.0931301936507225)
            report "Error detected at cycle 816: out0_0_out expected -0.0931301936507225, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.007004107348620892)) <= 0.0 + 1.0e-05 * abs(0.007004107348620892)
            report "Error detected at cycle 825: out0_0_out expected 0.007004107348620892, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.07240854203701019)) <= 0.0 + 1.0e-05 * abs(-0.07240854203701019)
            report "Error detected at cycle 832: out0_0_out expected -0.07240854203701019, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.007942136377096176)) <= 0.0 + 1.0e-05 * abs(0.007942136377096176)
            report "Error detected at cycle 840: out0_0_out expected 0.007942136377096176, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.1705726683139801)) <= 0.0 + 1.0e-05 * abs(-0.1705726683139801)
            report "Error detected at cycle 849: out0_0_out expected -0.1705726683139801, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.2874801754951477)) <= 0.0 + 1.0e-05 * abs(-0.2874801754951477)
            report "Error detected at cycle 857: out0_0_out expected -0.2874801754951477, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.03942936286330223)) <= 0.0 + 1.0e-05 * abs(-0.03942936286330223)
            report "Error detected at cycle 866: out0_0_out expected -0.03942936286330223, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 867
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.5250609517097473)) <= 0.0 + 1.0e-05 * abs(0.5250609517097473)
            report "Error detected at cycle 867: out0_0_out expected 0.5250609517097473, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.07523210346698761)) <= 0.0 + 1.0e-05 * abs(-0.07523210346698761)
            report "Error detected at cycle 876: out0_0_out expected -0.07523210346698761, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.020268496125936508)) <= 0.0 + 1.0e-05 * abs(-0.020268496125936508)
            report "Error detected at cycle 885: out0_0_out expected -0.020268496125936508, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.013914039358496666)) <= 0.0 + 1.0e-05 * abs(0.013914039358496666)
            report "Error detected at cycle 895: out0_0_out expected 0.013914039358496666, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.2634851038455963)) <= 0.0 + 1.0e-05 * abs(-0.2634851038455963)
            report "Error detected at cycle 904: out0_0_out expected -0.2634851038455963, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.04851575940847397)) <= 0.0 + 1.0e-05 * abs(0.04851575940847397)
            report "Error detected at cycle 913: out0_0_out expected 0.04851575940847397, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 914
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.13064123690128326)) <= 0.0 + 1.0e-05 * abs(-0.13064123690128326)
            report "Error detected at cycle 914: out0_0_out expected -0.13064123690128326, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.09702011197805405)) <= 0.0 + 1.0e-05 * abs(0.09702011197805405)
            report "Error detected at cycle 924: out0_0_out expected 0.09702011197805405, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.1454460620880127)) <= 0.0 + 1.0e-05 * abs(0.1454460620880127)
            report "Error detected at cycle 933: out0_0_out expected 0.1454460620880127, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.18194514513015747)) <= 0.0 + 1.0e-05 * abs(-0.18194514513015747)
            report "Error detected at cycle 942: out0_0_out expected -0.18194514513015747, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.06804811209440231)) <= 0.0 + 1.0e-05 * abs(0.06804811209440231)
            report "Error detected at cycle 953: out0_0_out expected 0.06804811209440231, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.0827391967177391)) <= 0.0 + 1.0e-05 * abs(-0.0827391967177391)
            report "Error detected at cycle 962: out0_0_out expected -0.0827391967177391, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.9502374529838562)) <= 0.0 + 1.0e-05 * abs(0.9502374529838562)
            report "Error detected at cycle 964: out0_0_out expected 0.9502374529838562, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.20848862826824188)) <= 0.0 + 1.0e-05 * abs(-0.20848862826824188)
            report "Error detected at cycle 971: out0_0_out expected -0.20848862826824188, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.029979869723320007)) <= 0.0 + 1.0e-05 * abs(-0.029979869723320007)
            report "Error detected at cycle 981: out0_0_out expected -0.029979869723320007, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.03399326652288437)) <= 0.0 + 1.0e-05 * abs(0.03399326652288437)
            report "Error detected at cycle 983: out0_0_out expected 0.03399326652288437, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.06502603739500046)) <= 0.0 + 1.0e-05 * abs(-0.06502603739500046)
            report "Error detected at cycle 992: out0_0_out expected -0.06502603739500046, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.14445462822914124)) <= 0.0 + 1.0e-05 * abs(0.14445462822914124)
            report "Error detected at cycle 1001: out0_0_out expected 0.14445462822914124, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.22975283861160278)) <= 0.0 + 1.0e-05 * abs(-0.22975283861160278)
            report "Error detected at cycle 1012: out0_0_out expected -0.22975283861160278, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.21584199368953705)) <= 0.0 + 1.0e-05 * abs(0.21584199368953705)
            report "Error detected at cycle 1020: out0_0_out expected 0.21584199368953705, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.13752800226211548)) <= 0.0 + 1.0e-05 * abs(-0.13752800226211548)
            report "Error detected at cycle 1022: out0_0_out expected -0.13752800226211548, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.10669464617967606)) <= 0.0 + 1.0e-05 * abs(-0.10669464617967606)
            report "Error detected at cycle 1031: out0_0_out expected -0.10669464617967606, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.13680604100227356)) <= 0.0 + 1.0e-05 * abs(0.13680604100227356)
            report "Error detected at cycle 1040: out0_0_out expected 0.13680604100227356, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.10311596095561981)) <= 0.0 + 1.0e-05 * abs(-0.10311596095561981)
            report "Error detected at cycle 1050: out0_0_out expected -0.10311596095561981, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1051
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.03924935311079025)) <= 0.0 + 1.0e-05 * abs(0.03924935311079025)
            report "Error detected at cycle 1051: out0_0_out expected 0.03924935311079025, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.014474628493189812)) <= 0.0 + 1.0e-05 * abs(0.014474628493189812)
            report "Error detected at cycle 1059: out0_0_out expected 0.014474628493189812, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.5708498358726501)) <= 0.0 + 1.0e-05 * abs(0.5708498358726501)
            report "Error detected at cycle 1062: out0_0_out expected 0.5708498358726501, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.12730126082897186)) <= 0.0 + 1.0e-05 * abs(-0.12730126082897186)
            report "Error detected at cycle 1069: out0_0_out expected -0.12730126082897186, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.03195594996213913)) <= 0.0 + 1.0e-05 * abs(0.03195594996213913)
            report "Error detected at cycle 1079: out0_0_out expected 0.03195594996213913, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1080
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.015442159958183765)) <= 0.0 + 1.0e-05 * abs(0.015442159958183765)
            report "Error detected at cycle 1080: out0_0_out expected 0.015442159958183765, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.06466279923915863)) <= 0.0 + 1.0e-05 * abs(-0.06466279923915863)
            report "Error detected at cycle 1088: out0_0_out expected -0.06466279923915863, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.05580083280801773)) <= 0.0 + 1.0e-05 * abs(0.05580083280801773)
            report "Error detected at cycle 1097: out0_0_out expected 0.05580083280801773, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.0063568465411663055)) <= 0.0 + 1.0e-05 * abs(0.0063568465411663055)
            report "Error detected at cycle 1107: out0_0_out expected 0.0063568465411663055, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1108
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.04903075098991394)) <= 0.0 + 1.0e-05 * abs(-0.04903075098991394)
            report "Error detected at cycle 1108: out0_0_out expected -0.04903075098991394, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.16565842926502228)) <= 0.0 + 1.0e-05 * abs(-0.16565842926502228)
            report "Error detected at cycle 1115: out0_0_out expected -0.16565842926502228, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1116
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.03877269849181175)) <= 0.0 + 1.0e-05 * abs(-0.03877269849181175)
            report "Error detected at cycle 1116: out0_0_out expected -0.03877269849181175, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.1013529971241951)) <= 0.0 + 1.0e-05 * abs(-0.1013529971241951)
            report "Error detected at cycle 1124: out0_0_out expected -0.1013529971241951, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.1079598069190979)) <= 0.0 + 1.0e-05 * abs(-0.1079598069190979)
            report "Error detected at cycle 1134: out0_0_out expected -0.1079598069190979, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.10581439733505249)) <= 0.0 + 1.0e-05 * abs(-0.10581439733505249)
            report "Error detected at cycle 1141: out0_0_out expected -0.10581439733505249, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.23986510932445526)) <= 0.0 + 1.0e-05 * abs(-0.23986510932445526)
            report "Error detected at cycle 1143: out0_0_out expected -0.23986510932445526, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.17547553777694702)) <= 0.0 + 1.0e-05 * abs(-0.17547553777694702)
            report "Error detected at cycle 1150: out0_0_out expected -0.17547553777694702, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.6682536602020264)) <= 0.0 + 1.0e-05 * abs(0.6682536602020264)
            report "Error detected at cycle 1152: out0_0_out expected 0.6682536602020264, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.04815756529569626)) <= 0.0 + 1.0e-05 * abs(-0.04815756529569626)
            report "Error detected at cycle 1160: out0_0_out expected -0.04815756529569626, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.21714015305042267)) <= 0.0 + 1.0e-05 * abs(-0.21714015305042267)
            report "Error detected at cycle 1166: out0_0_out expected -0.21714015305042267, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.014418991282582283)) <= 0.0 + 1.0e-05 * abs(-0.014418991282582283)
            report "Error detected at cycle 1168: out0_0_out expected -0.014418991282582283, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.0699249729514122)) <= 0.0 + 1.0e-05 * abs(-0.0699249729514122)
            report "Error detected at cycle 1175: out0_0_out expected -0.0699249729514122, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.13348814845085144)) <= 0.0 + 1.0e-05 * abs(0.13348814845085144)
            report "Error detected at cycle 1180: out0_0_out expected 0.13348814845085144, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.0023358725011348724)) <= 0.0 + 1.0e-05 * abs(-0.0023358725011348724)
            report "Error detected at cycle 1183: out0_0_out expected -0.0023358725011348724, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.1247539222240448)) <= 0.0 + 1.0e-05 * abs(0.1247539222240448)
            report "Error detected at cycle 1189: out0_0_out expected 0.1247539222240448, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.20743325352668762)) <= 0.0 + 1.0e-05 * abs(0.20743325352668762)
            report "Error detected at cycle 1191: out0_0_out expected 0.20743325352668762, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.10327304899692535)) <= 0.0 + 1.0e-05 * abs(0.10327304899692535)
            report "Error detected at cycle 1197: out0_0_out expected 0.10327304899692535, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.05220543220639229)) <= 0.0 + 1.0e-05 * abs(-0.05220543220639229)
            report "Error detected at cycle 1202: out0_0_out expected -0.05220543220639229, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.053609464317560196)) <= 0.0 + 1.0e-05 * abs(0.053609464317560196)
            report "Error detected at cycle 1205: out0_0_out expected 0.053609464317560196, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.18026866018772125)) <= 0.0 + 1.0e-05 * abs(-0.18026866018772125)
            report "Error detected at cycle 1210: out0_0_out expected -0.18026866018772125, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.09743928164243698)) <= 0.0 + 1.0e-05 * abs(-0.09743928164243698)
            report "Error detected at cycle 1217: out0_0_out expected -0.09743928164243698, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.13309159874916077)) <= 0.0 + 1.0e-05 * abs(0.13309159874916077)
            report "Error detected at cycle 1221: out0_0_out expected 0.13309159874916077, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.08773498237133026)) <= 0.0 + 1.0e-05 * abs(-0.08773498237133026)
            report "Error detected at cycle 1224: out0_0_out expected -0.08773498237133026, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1225
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.8664875626564026)) <= 0.0 + 1.0e-05 * abs(0.8664875626564026)
            report "Error detected at cycle 1225: out0_0_out expected 0.8664875626564026, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.12673886120319366)) <= 0.0 + 1.0e-05 * abs(-0.12673886120319366)
            report "Error detected at cycle 1229: out0_0_out expected -0.12673886120319366, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.11387381702661514)) <= 0.0 + 1.0e-05 * abs(-0.11387381702661514)
            report "Error detected at cycle 1235: out0_0_out expected -0.11387381702661514, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.1808612197637558)) <= 0.0 + 1.0e-05 * abs(-0.1808612197637558)
            report "Error detected at cycle 1240: out0_0_out expected -0.1808612197637558, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1241
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.056816041469573975)) <= 0.0 + 1.0e-05 * abs(-0.056816041469573975)
            report "Error detected at cycle 1241: out0_0_out expected -0.056816041469573975, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.10088717192411423)) <= 0.0 + 1.0e-05 * abs(-0.10088717192411423)
            report "Error detected at cycle 1245: out0_0_out expected -0.10088717192411423, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.3486635982990265)) <= 0.0 + 1.0e-05 * abs(-0.3486635982990265)
            report "Error detected at cycle 1250: out0_0_out expected -0.3486635982990265, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.04933243989944458)) <= 0.0 + 1.0e-05 * abs(0.04933243989944458)
            report "Error detected at cycle 1253: out0_0_out expected 0.04933243989944458, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.13691915571689606)) <= 0.0 + 1.0e-05 * abs(-0.13691915571689606)
            report "Error detected at cycle 1255: out0_0_out expected -0.13691915571689606, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.023970836773514748)) <= 0.0 + 1.0e-05 * abs(0.023970836773514748)
            report "Error detected at cycle 1259: out0_0_out expected 0.023970836773514748, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.044381704181432724)) <= 0.0 + 1.0e-05 * abs(-0.044381704181432724)
            report "Error detected at cycle 1267: out0_0_out expected -0.044381704181432724, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1268
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.10683455318212509)) <= 0.0 + 1.0e-05 * abs(-0.10683455318212509)
            report "Error detected at cycle 1268: out0_0_out expected -0.10683455318212509, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.12928462028503418)) <= 0.0 + 1.0e-05 * abs(0.12928462028503418)
            report "Error detected at cycle 1271: out0_0_out expected 0.12928462028503418, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1272
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.8280317783355713)) <= 0.0 + 1.0e-05 * abs(0.8280317783355713)
            report "Error detected at cycle 1272: out0_0_out expected 0.8280317783355713, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.033007219433784485)) <= 0.0 + 1.0e-05 * abs(-0.033007219433784485)
            report "Error detected at cycle 1278: out0_0_out expected -0.033007219433784485, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1279
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.031012192368507385)) <= 0.0 + 1.0e-05 * abs(0.031012192368507385)
            report "Error detected at cycle 1279: out0_0_out expected 0.031012192368507385, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.1656889170408249)) <= 0.0 + 1.0e-05 * abs(-0.1656889170408249)
            report "Error detected at cycle 1281: out0_0_out expected -0.1656889170408249, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.0059214625507593155)) <= 0.0 + 1.0e-05 * abs(-0.0059214625507593155)
            report "Error detected at cycle 1287: out0_0_out expected -0.0059214625507593155, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 1288
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.043869540095329285)) <= 0.0 + 1.0e-05 * abs(-0.043869540095329285)
            report "Error detected at cycle 1288: out0_0_out expected -0.043869540095329285, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.2086651623249054)) <= 0.0 + 1.0e-05 * abs(0.2086651623249054)
            report "Error detected at cycle 1291: out0_0_out expected 0.2086651623249054, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.13278943300247192)) <= 0.0 + 1.0e-05 * abs(-0.13278943300247192)
            report "Error detected at cycle 1297: out0_0_out expected -0.13278943300247192, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.1919882595539093)) <= 0.0 + 1.0e-05 * abs(0.1919882595539093)
            report "Error detected at cycle 1301: out0_0_out expected 0.1919882595539093, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.6109279990196228)) <= 0.0 + 1.0e-05 * abs(0.6109279990196228)
            report "Error detected at cycle 1303: out0_0_out expected 0.6109279990196228, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.02912379615008831)) <= 0.0 + 1.0e-05 * abs(0.02912379615008831)
            report "Error detected at cycle 1305: out0_0_out expected 0.02912379615008831, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.16041617095470428)) <= 0.0 + 1.0e-05 * abs(-0.16041617095470428)
            report "Error detected at cycle 1310: out0_0_out expected -0.16041617095470428, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.2262117564678192)) <= 0.0 + 1.0e-05 * abs(-0.2262117564678192)
            report "Error detected at cycle 1313: out0_0_out expected -0.2262117564678192, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.015325754880905151)) <= 0.0 + 1.0e-05 * abs(-0.015325754880905151)
            report "Error detected at cycle 1318: out0_0_out expected -0.015325754880905151, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.14532886445522308)) <= 0.0 + 1.0e-05 * abs(-0.14532886445522308)
            report "Error detected at cycle 1322: out0_0_out expected -0.14532886445522308, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.14923670887947083)) <= 0.0 + 1.0e-05 * abs(0.14923670887947083)
            report "Error detected at cycle 1330: out0_0_out expected 0.14923670887947083, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.7417508363723755)) <= 0.0 + 1.0e-05 * abs(0.7417508363723755)
            report "Error detected at cycle 1334: out0_0_out expected 0.7417508363723755, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.07983817905187607)) <= 0.0 + 1.0e-05 * abs(0.07983817905187607)
            report "Error detected at cycle 1338: out0_0_out expected 0.07983817905187607, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.1771831214427948)) <= 0.0 + 1.0e-05 * abs(-0.1771831214427948)
            report "Error detected at cycle 1350: out0_0_out expected -0.1771831214427948, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.6358357071876526)) <= 0.0 + 1.0e-05 * abs(0.6358357071876526)
            report "Error detected at cycle 1366: out0_0_out expected 0.6358357071876526, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
