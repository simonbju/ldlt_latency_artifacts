...
begin
    ...
    begin
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (1.0510835647583008)) <= 0.0 + 1.0e-06 * abs(1.0510835647583008)
            report "Error detected at cycle 350: out0_0_out expected 1.0510835647583008, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.9415566325187683)) <= 0.0 + 1.0e-06 * abs(0.9415566325187683)
            report "Error detected at cycle 404: out0_0_out expected 0.9415566325187683, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 405
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.2517518699169159)) <= 0.0 + 1.0e-06 * abs(-0.2517518699169159)
            report "Error detected at cycle 405: out0_0_out expected -0.2517518699169159, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 406
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.16755735874176025)) <= 0.0 + 1.0e-06 * abs(-0.16755735874176025)
            report "Error detected at cycle 406: out0_0_out expected -0.16755735874176025, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 407
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.015931103378534317)) <= 0.0 + 1.0e-06 * abs(0.015931103378534317)
            report "Error detected at cycle 407: out0_0_out expected 0.015931103378534317, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 408
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.06526713073253632)) <= 0.0 + 1.0e-06 * abs(-0.06526713073253632)
            report "Error detected at cycle 408: out0_0_out expected -0.06526713073253632, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 409
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.024414032697677612)) <= 0.0 + 1.0e-06 * abs(0.024414032697677612)
            report "Error detected at cycle 409: out0_0_out expected 0.024414032697677612, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 410
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.02810475043952465)) <= 0.0 + 1.0e-06 * abs(-0.02810475043952465)
            report "Error detected at cycle 410: out0_0_out expected -0.02810475043952465, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 411
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.8987186551094055)) <= 0.0 + 1.0e-06 * abs(0.8987186551094055)
            report "Error detected at cycle 411: out0_0_out expected 0.8987186551094055, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 412
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.31340861320495605)) <= 0.0 + 1.0e-06 * abs(-0.31340861320495605)
            report "Error detected at cycle 412: out0_0_out expected -0.31340861320495605, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 413
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.17301534116268158)) <= 0.0 + 1.0e-06 * abs(0.17301534116268158)
            report "Error detected at cycle 413: out0_0_out expected 0.17301534116268158, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 414
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.7379545569419861)) <= 0.0 + 1.0e-06 * abs(-0.7379545569419861)
            report "Error detected at cycle 414: out0_0_out expected -0.7379545569419861, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 415
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.14009636640548706)) <= 0.0 + 1.0e-06 * abs(0.14009636640548706)
            report "Error detected at cycle 415: out0_0_out expected 0.14009636640548706, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 416
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.7697655558586121)) <= 0.0 + 1.0e-06 * abs(-0.7697655558586121)
            report "Error detected at cycle 416: out0_0_out expected -0.7697655558586121, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 417
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.0341726578772068)) <= 0.0 + 1.0e-06 * abs(-0.0341726578772068)
            report "Error detected at cycle 417: out0_0_out expected -0.0341726578772068, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 418
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.9863976240158081)) <= 0.0 + 1.0e-06 * abs(0.9863976240158081)
            report "Error detected at cycle 418: out0_0_out expected 0.9863976240158081, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 419
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (4.153718948364258)) <= 0.0 + 1.0e-06 * abs(4.153718948364258)
            report "Error detected at cycle 419: out0_0_out expected 4.153718948364258, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 420
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (3.329749584197998)) <= 0.0 + 1.0e-06 * abs(3.329749584197998)
            report "Error detected at cycle 420: out0_0_out expected 3.329749584197998, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 421
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-2.737523317337036)) <= 0.0 + 1.0e-06 * abs(-2.737523317337036)
            report "Error detected at cycle 421: out0_0_out expected -2.737523317337036, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 422
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.7976441383361816)) <= 0.0 + 1.0e-06 * abs(-0.7976441383361816)
            report "Error detected at cycle 422: out0_0_out expected -0.7976441383361816, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 423
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (2.395599603652954)) <= 0.0 + 1.0e-06 * abs(2.395599603652954)
            report "Error detected at cycle 423: out0_0_out expected 2.395599603652954, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 424
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.8248156905174255)) <= 0.0 + 1.0e-06 * abs(-0.8248156905174255)
            report "Error detected at cycle 424: out0_0_out expected -0.8248156905174255, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 425
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.8312460780143738)) <= 0.0 + 1.0e-06 * abs(0.8312460780143738)
            report "Error detected at cycle 425: out0_0_out expected 0.8312460780143738, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 426
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.4503380060195923)) <= 0.0 + 1.0e-06 * abs(0.4503380060195923)
            report "Error detected at cycle 426: out0_0_out expected 0.4503380060195923, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 427
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.06353038549423218)) <= 0.0 + 1.0e-06 * abs(0.06353038549423218)
            report "Error detected at cycle 427: out0_0_out expected 0.06353038549423218, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 428
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.6361395120620728)) <= 0.0 + 1.0e-06 * abs(-0.6361395120620728)
            report "Error detected at cycle 428: out0_0_out expected -0.6361395120620728, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 429
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (3.556330919265747)) <= 0.0 + 1.0e-06 * abs(3.556330919265747)
            report "Error detected at cycle 429: out0_0_out expected 3.556330919265747, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 430
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-3.0796568393707275)) <= 0.0 + 1.0e-06 * abs(-3.0796568393707275)
            report "Error detected at cycle 430: out0_0_out expected -3.0796568393707275, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 431
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-1.0891661643981934)) <= 0.0 + 1.0e-06 * abs(-1.0891661643981934)
            report "Error detected at cycle 431: out0_0_out expected -1.0891661643981934, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 432
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (1.0652419328689575)) <= 0.0 + 1.0e-06 * abs(1.0652419328689575)
            report "Error detected at cycle 432: out0_0_out expected 1.0652419328689575, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 433
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (1.027105689048767)) <= 0.0 + 1.0e-06 * abs(1.027105689048767)
            report "Error detected at cycle 433: out0_0_out expected 1.027105689048767, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 434
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.7076719403266907)) <= 0.0 + 1.0e-06 * abs(-0.7076719403266907)
            report "Error detected at cycle 434: out0_0_out expected -0.7076719403266907, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 435
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.2503596842288971)) <= 0.0 + 1.0e-06 * abs(0.2503596842288971)
            report "Error detected at cycle 435: out0_0_out expected 0.2503596842288971, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 436
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.7355763912200928)) <= 0.0 + 1.0e-06 * abs(-0.7355763912200928)
            report "Error detected at cycle 436: out0_0_out expected -0.7355763912200928, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 437
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.23788899183273315)) <= 0.0 + 1.0e-06 * abs(0.23788899183273315)
            report "Error detected at cycle 437: out0_0_out expected 0.23788899183273315, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 438
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.2193092256784439)) <= 0.0 + 1.0e-06 * abs(0.2193092256784439)
            report "Error detected at cycle 438: out0_0_out expected 0.2193092256784439, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
