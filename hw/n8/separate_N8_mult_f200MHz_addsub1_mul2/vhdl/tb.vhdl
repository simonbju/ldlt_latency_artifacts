...
begin
    ...
    begin
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (1.0510835647583008)) <= 0.0 + 1.0e-05 * abs(1.0510835647583008)
            report "Error detected at cycle 197: out0_0_out expected 1.0510835647583008, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.9415566325187683)) <= 0.0 + 1.0e-05 * abs(0.9415566325187683)
            report "Error detected at cycle 224: out0_0_out expected 0.9415566325187683, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 225
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.02810475043952465)) <= 0.0 + 1.0e-05 * abs(-0.02810475043952465)
            report "Error detected at cycle 225: out0_0_out expected -0.02810475043952465, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 226
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.9863976240158081)) <= 0.0 + 1.0e-05 * abs(0.9863976240158081)
            report "Error detected at cycle 226: out0_0_out expected 0.9863976240158081, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 227
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.06526713073253632)) <= 0.0 + 1.0e-05 * abs(-0.06526713073253632)
            report "Error detected at cycle 227: out0_0_out expected -0.06526713073253632, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 228
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.7076719403266907)) <= 0.0 + 1.0e-05 * abs(-0.7076719403266907)
            report "Error detected at cycle 228: out0_0_out expected -0.7076719403266907, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 229
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (2.395599603652954)) <= 0.0 + 1.0e-05 * abs(2.395599603652954)
            report "Error detected at cycle 229: out0_0_out expected 2.395599603652954, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 230
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.8248156905174255)) <= 0.0 + 1.0e-05 * abs(-0.8248156905174255)
            report "Error detected at cycle 230: out0_0_out expected -0.8248156905174255, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 231
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (3.329749584197998)) <= 0.0 + 1.0e-05 * abs(3.329749584197998)
            report "Error detected at cycle 231: out0_0_out expected 3.329749584197998, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 232
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.8312460780143738)) <= 0.0 + 1.0e-05 * abs(0.8312460780143738)
            report "Error detected at cycle 232: out0_0_out expected 0.8312460780143738, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 233
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.6361395120620728)) <= 0.0 + 1.0e-05 * abs(-0.6361395120620728)
            report "Error detected at cycle 233: out0_0_out expected -0.6361395120620728, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 234
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (3.556330919265747)) <= 0.0 + 1.0e-05 * abs(3.556330919265747)
            report "Error detected at cycle 234: out0_0_out expected 3.556330919265747, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 235
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.14009636640548706)) <= 0.0 + 1.0e-05 * abs(0.14009636640548706)
            report "Error detected at cycle 235: out0_0_out expected 0.14009636640548706, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 236
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-1.0891661643981934)) <= 0.0 + 1.0e-05 * abs(-1.0891661643981934)
            report "Error detected at cycle 236: out0_0_out expected -1.0891661643981934, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 237
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-3.0796568393707275)) <= 0.0 + 1.0e-05 * abs(-3.0796568393707275)
            report "Error detected at cycle 237: out0_0_out expected -3.0796568393707275, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 238
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (1.0652419328689575)) <= 0.0 + 1.0e-05 * abs(1.0652419328689575)
            report "Error detected at cycle 238: out0_0_out expected 1.0652419328689575, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 239
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (1.027105689048767)) <= 0.0 + 1.0e-05 * abs(1.027105689048767)
            report "Error detected at cycle 239: out0_0_out expected 1.027105689048767, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 240
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.7976441383361816)) <= 0.0 + 1.0e-05 * abs(-0.7976441383361816)
            report "Error detected at cycle 240: out0_0_out expected -0.7976441383361816, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 241
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.06353038549423218)) <= 0.0 + 1.0e-05 * abs(0.06353038549423218)
            report "Error detected at cycle 241: out0_0_out expected 0.06353038549423218, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 242
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.4503380060195923)) <= 0.0 + 1.0e-05 * abs(0.4503380060195923)
            report "Error detected at cycle 242: out0_0_out expected 0.4503380060195923, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 243
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.7379545569419861)) <= 0.0 + 1.0e-05 * abs(-0.7379545569419861)
            report "Error detected at cycle 243: out0_0_out expected -0.7379545569419861, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 244
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.17301534116268158)) <= 0.0 + 1.0e-05 * abs(0.17301534116268158)
            report "Error detected at cycle 244: out0_0_out expected 0.17301534116268158, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 245
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.8987186551094055)) <= 0.0 + 1.0e-05 * abs(0.8987186551094055)
            report "Error detected at cycle 245: out0_0_out expected 0.8987186551094055, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 246
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-2.737523317337036)) <= 0.0 + 1.0e-05 * abs(-2.737523317337036)
            report "Error detected at cycle 246: out0_0_out expected -2.737523317337036, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 247
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.7697655558586121)) <= 0.0 + 1.0e-05 * abs(-0.7697655558586121)
            report "Error detected at cycle 247: out0_0_out expected -0.7697655558586121, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 248
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.015931103378534317)) <= 0.0 + 1.0e-05 * abs(0.015931103378534317)
            report "Error detected at cycle 248: out0_0_out expected 0.015931103378534317, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 249
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.2503596842288971)) <= 0.0 + 1.0e-05 * abs(0.2503596842288971)
            report "Error detected at cycle 249: out0_0_out expected 0.2503596842288971, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 250
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.7355763912200928)) <= 0.0 + 1.0e-05 * abs(-0.7355763912200928)
            report "Error detected at cycle 250: out0_0_out expected -0.7355763912200928, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 251
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.024414032697677612)) <= 0.0 + 1.0e-05 * abs(0.024414032697677612)
            report "Error detected at cycle 251: out0_0_out expected 0.024414032697677612, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 252
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.31340861320495605)) <= 0.0 + 1.0e-05 * abs(-0.31340861320495605)
            report "Error detected at cycle 252: out0_0_out expected -0.31340861320495605, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 253
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.23788899183273315)) <= 0.0 + 1.0e-05 * abs(0.23788899183273315)
            report "Error detected at cycle 253: out0_0_out expected 0.23788899183273315, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 254
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.2193092256784439)) <= 0.0 + 1.0e-05 * abs(0.2193092256784439)
            report "Error detected at cycle 254: out0_0_out expected 0.2193092256784439, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 255
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.0341726578772068)) <= 0.0 + 1.0e-05 * abs(-0.0341726578772068)
            report "Error detected at cycle 255: out0_0_out expected -0.0341726578772068, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 256
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (4.153718948364258)) <= 0.0 + 1.0e-05 * abs(4.153718948364258)
            report "Error detected at cycle 256: out0_0_out expected 4.153718948364258, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 257
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.16755735874176025)) <= 0.0 + 1.0e-05 * abs(-0.16755735874176025)
            report "Error detected at cycle 257: out0_0_out expected -0.16755735874176025, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 258
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.2517518699169159)) <= 0.0 + 1.0e-05 * abs(-0.2517518699169159)
            report "Error detected at cycle 258: out0_0_out expected -0.2517518699169159, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
