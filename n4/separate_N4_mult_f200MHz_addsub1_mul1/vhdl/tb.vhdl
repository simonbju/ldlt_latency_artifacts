...
begin
    ...
    begin
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (1.0536752939224243)) <= 0.0 + 1.0e-05 * abs(1.0536752939224243)
            report "Error detected at cycle 108: out0_0_out expected 1.0536752939224243, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 109
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.28239163756370544)) <= 0.0 + 1.0e-05 * abs(-0.28239163756370544)
            report "Error detected at cycle 109: out0_0_out expected -0.28239163756370544, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 110
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.9954698085784912)) <= 0.0 + 1.0e-05 * abs(0.9954698085784912)
            report "Error detected at cycle 110: out0_0_out expected 0.9954698085784912, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 111
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.2646608352661133)) <= 0.0 + 1.0e-05 * abs(-0.2646608352661133)
            report "Error detected at cycle 111: out0_0_out expected -0.2646608352661133, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 112
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.4431895315647125)) <= 0.0 + 1.0e-05 * abs(-0.4431895315647125)
            report "Error detected at cycle 112: out0_0_out expected -0.4431895315647125, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 113
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.11636444926261902)) <= 0.0 + 1.0e-05 * abs(-0.11636444926261902)
            report "Error detected at cycle 113: out0_0_out expected -0.11636444926261902, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 114
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.9818478226661682)) <= 0.0 + 1.0e-05 * abs(0.9818478226661682)
            report "Error detected at cycle 114: out0_0_out expected 0.9818478226661682, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 115
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.054051343351602554)) <= 0.0 + 1.0e-05 * abs(0.054051343351602554)
            report "Error detected at cycle 115: out0_0_out expected 0.054051343351602554, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 116
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.4604877531528473)) <= 0.0 + 1.0e-05 * abs(-0.4604877531528473)
            report "Error detected at cycle 116: out0_0_out expected -0.4604877531528473, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
