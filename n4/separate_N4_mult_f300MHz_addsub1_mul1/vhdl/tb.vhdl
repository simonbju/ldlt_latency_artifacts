...
begin
    ...
    begin
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (1.659786581993103)) <= 0.0 + 1.0e-05 * abs(1.659786581993103)
            report "Error detected at cycle 141: out0_0_out expected 1.659786581993103, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
        ...
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.4604877531528473)) <= 0.0 + 1.0e-05 * abs(-0.4604877531528473)
            report "Error detected at cycle 159: out0_0_out expected -0.4604877531528473, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 160
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.11636444926261902)) <= 0.0 + 1.0e-05 * abs(-0.11636444926261902)
            report "Error detected at cycle 160: out0_0_out expected -0.11636444926261902, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 161
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.2646608352661133)) <= 0.0 + 1.0e-05 * abs(-0.2646608352661133)
            report "Error detected at cycle 161: out0_0_out expected -0.2646608352661133, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 162
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (1.0536752939224243)) <= 0.0 + 1.0e-05 * abs(1.0536752939224243)
            report "Error detected at cycle 162: out0_0_out expected 1.0536752939224243, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 163
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.28239163756370544)) <= 0.0 + 1.0e-05 * abs(-0.28239163756370544)
            report "Error detected at cycle 163: out0_0_out expected -0.28239163756370544, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 164
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.9954698085784912)) <= 0.0 + 1.0e-05 * abs(0.9954698085784912)
            report "Error detected at cycle 164: out0_0_out expected 0.9954698085784912, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 165
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (-0.4431895315647125)) <= 0.0 + 1.0e-05 * abs(-0.4431895315647125)
            report "Error detected at cycle 165: out0_0_out expected -0.4431895315647125, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 166
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.9818478226661682)) <= 0.0 + 1.0e-05 * abs(0.9818478226661682)
            report "Error detected at cycle 166: out0_0_out expected 0.9818478226661682, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);

        -- Cycle 167
        assert abs(to_real(to_float(out0_0_out, 8, 23)) - (0.054051343351602554)) <= 0.0 + 1.0e-05 * abs(0.054051343351602554)
            report "Error detected at cycle 167: out0_0_out expected 0.054051343351602554, got " & real'image(to_real(to_float(out0_0_out, 8, 23))) severity failure;
        wait until falling_edge(clk);
